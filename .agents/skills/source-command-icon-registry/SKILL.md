---
name: "source-command-icon-registry"
description: "Migrated source command `icon-registry`"
---

# source-command-icon-registry

Use this skill when the user asks to run the migrated source command `icon-registry`.
