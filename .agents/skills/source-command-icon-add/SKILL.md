---
name: "source-command-icon-add"
description: "Migrated source command `icon-add`"
---

# source-command-icon-add

Use this skill when the user asks to run the migrated source command `icon-add`.
