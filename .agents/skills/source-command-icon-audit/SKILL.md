---
name: "source-command-icon-audit"
description: "Migrated source command `icon-audit`"
---

# source-command-icon-audit

Use this skill when the user asks to run the migrated source command `icon-audit`.
