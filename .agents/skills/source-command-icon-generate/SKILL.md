---
name: "source-command-icon-generate"
description: "Migrated source command `icon-generate`"
---

# source-command-icon-generate

Use this skill when the user asks to run the migrated source command `icon-generate`.
