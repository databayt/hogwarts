---
name: "source-command-icon-fetch"
description: "Migrated source command `icon-fetch`"
---

# source-command-icon-fetch

Use this skill when the user asks to run the migrated source command `icon-fetch`.
...
- **Codex**: sparkle, wordmark, for-personal, for-work
