---
name: "source-command-icon-migrate"
description: "Migrated source command `icon-migrate`"
---

# source-command-icon-migrate

Use this skill when the user asks to run the migrated source command `icon-migrate`.
