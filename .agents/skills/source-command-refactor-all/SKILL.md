---
name: "source-command-refactor-all"
description: "Migrated source command `refactor-all`"
---

# source-command-refactor-all

Use this skill when the user asks to run the migrated source command `refactor-all`.
