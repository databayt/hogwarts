---
name: "source-command-icon-validate"
description: "Migrated source command `icon-validate`"
---

# source-command-icon-validate

Use this skill when the user asks to run the migrated source command `icon-validate`.
