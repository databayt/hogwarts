...
| `catalog-images`    | رفع صور ClickView إلى S3/CloudFront               |
| `clickview-catalog` | كتالوج ClickView US (62 مادة، 201 فصل، 986 درساً) |
| `clickview-images`  | رفع صور مواد ClickView                            |
...
pnpm db:seed:single clickview-catalog       # seed عام (يعمل على DB فارغة)
