...
`demo.localhost:3000`) تعرض صفحة الدخول **قائمة أدوار** بدل حقول بيانات الاعتماد: اختر
مدير المدرسة أو معلم أو طالب أو ولي أمر أو محاسب أو موظف ثم اضغط دخول. ورابط "الدخول
بالبريد الإلكتروني" يُظهر النموذج المعتاد.
