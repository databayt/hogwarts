...
- **تخزين بلغة واحدة** — المحتوى يُخزَّن بلغة واحدة مع حقل `lang`، والترجمة عند الطلب عبر Google Translate مع تخزين في `TranslationCache`.
...
| البنية الأكاديمية                                 |      13 | `academic-structure.prisma`, `subjects.prisma`, `classrooms.prisma`, `enrollment.prisma`                                                                                                               |
...
| تدقيق / أمن / متفرق                               |      10 | `audit.prisma`, `legal.prisma`, `webhooks.prisma`, `task.prisma`, `translation-cache.prisma`, `purge-tokens.prisma`                                                                                    |
...
المحتوى يُخزَّن بلغة واحدة مع حقل `lang`. الترجمة عند الطلب عبر Google Translate API، مع تخزين في `TranslationCache`.
