...
```tsx
import { Uploader } from "@/components/platform/file"
...
```tsx
import { Importer, type ImportColumn } from "@/components/platform/file"
...
|-------------|--------|-----------|
| `src/lib/csv-export.ts` | Deprecated | Use `@/components/platform/file` |
| `src/lib/csv-import.ts` | Domain-specific | Use for bulk student/teacher DB imports |
| `src/components/file-upload/` | Deprecated | Use `@/components/platform/file` |
