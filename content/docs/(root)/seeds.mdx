...
|-------|---------|--------|
| Name | Demo School | مدرسة تجريبية |
...
|---------|-------------|-------------|----------|
| Kindergarten | KG 1, KG 2 | روضة أولى، روضة ثانية | 200 |
| Primary | Grade 1-6 | الصف الأول - السادس | 460 |
| Intermediate | Grade 7-9 | الصف السابع - التاسع | 180 |
| Secondary | Grade 10-12 | الصف العاشر - الثاني عشر | 160 |
...
```typescript
// ✅ CORRECT - Personal emails like real users (no dots)
"osman@gmail.com"
"fatimahassan@hotmail.com"
"ahmedkhalid@outlook.com"
"mariam42@yahoo.com"

// ❌ WRONG - Avoid numbered IDs
