...
2. **Invitation system** - Schools invite users with pre-assigned roles
3. **School join codes** - Simple codes like "HOGWARTS-2024" for easy joining

### Medium-term (P1)

4. **Bulk user creation** - CSV import for students/teachers
