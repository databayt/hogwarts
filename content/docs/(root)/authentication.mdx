...
| --------- | --------------- | ---------------------- | -------------- |
| DEVELOPER | ed.databayt.org | `/{locale}/dashboard`  | ✅ Implemented |
| ADMIN     | ed.databayt.org | `/{locale}` (homepage) | ✅ Implemented |
| TEACHER   | ed.databayt.org | `/{locale}` (homepage) | ✅ Implemented |
| STUDENT   | ed.databayt.org | `/{locale}` (homepage) | ✅ Implemented |
| GUARDIAN  | ed.databayt.org | `/{locale}` (homepage) | ✅ Implemented |
