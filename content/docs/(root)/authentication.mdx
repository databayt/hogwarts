...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  1️⃣  USER MENU DROPDOWN                                                     │
│      └── Click avatar → "Logout" → Clears session → /login                  │
│                                                                              │
│  2️⃣  SESSION EXPIRY                                                         │
│      └── JWT expires (24 hours) → Next request → /login?callbackUrl={url}   │
│                                                                              │
│  3️⃣  PROGRAMMATIC SIGNOUT                                                   │
│      └── signOut() called → Clears session → /login                         │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
└────────┬────────┘           └──────────┬──────────┘           └────────┬────────┘
         ...
         └───────────────────────────────┼───────────────────────────────┘
                    ...
                    │                                     │
                    │  Redirect to: /login               │
                    │  (with callbackUrl if applicable)   │
                    └─────────────────────────────────────┘
```
...
| --- | --------------- | ---------------- | ---------------- | ------------------------------ |
| 1   | Avatar dropdown | Platform header  | `UserButton`     | `/login`                       |
| 2   | Settings page   | Account settings | Logout button    | `/login`                       |
| 3   | Session expiry  | Automatic        | JWT timeout      | `/login?callbackUrl={current}` |
| 4   | Sign out action | Any page         | `signOut()` call | `/login` or custom             |
