...
<div className="grid gap-3 grid-cols-4">
  ...
  <MetricCard title="Attendance" value={`${attendance.rate}%`} icon={CalendarCheck} />
...
```tsx
const actions = [
  { icon: UserPlus, label: "Add Student", description: "Enroll new student", href: "/students/new" },
  { icon: Bell, label: "Announce", description: "Send notification", href: "/announcements/new" },
  { icon: FileText, label: "View Reports", description: "Analytics & data", href: "/admin/reports" },
  { icon: CreditCard, label: "Billing", description: "Manage payments", href: "/billing" },
];
```
