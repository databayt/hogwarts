...
<Tabs defaultValue="npm">
  ...
  <TabsContent value="npm">npm install package</TabsContent>
  <TabsContent value="yarn">yarn add package</TabsContent>
  <TabsContent value="pnpm">pnpm add package</TabsContent>
</Tabs>
```
...
```mdx
<ComponentPreview className="[&_.preview]:w-full" code={responsiveCode}>
  <ResponsiveComponent />
</ComponentPreview>
```
