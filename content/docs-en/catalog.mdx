...
|                                                             |
|  CatalogSubject (240 US K-12 + 97 Sudan national)          |
|    > CatalogChapter (~1,156 topic groups)                   |
|        > CatalogLesson (~5,042 sub-topics)                  |
|                                                             |
...
**Slug convention:** `us-g{N}-{subject-slug}` (e.g., `us-g3-math`, `us-g11-chemistry`)
