...
```typescript
// GOOD: config.ts — imports types, exports constants
...
> **Note:** `src/lib/constants/` doesn't exist yet — this is the target location for shared constants migration. Currently, duplicated constants remain in feature config files.
...
// apply/personal/config.ts: { value: "MALE", label: "ذكر" }
...
export const STEP_FIELDS = {
  1: ["firstName", "lastName", "gender", "birthDate"] as const,
