...
This guide documents the complete Claude Code setup for this Next.js 16 project, including current configuration, specialized agents, MCP integrations, and optimization recommendations.
...
- **Content**: Next.js 16 specifics, authentication flows, i18n setup, styling conventions
