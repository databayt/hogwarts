...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│   1. FORK/CLONE          2. BRANCH           3. DEVELOP                     │
│   ┌──────────┐          ┌──────────┐        ┌──────────┐                    │
│   │  Fork    │ ───────► │ Feature  │ ─────► │  Code    │                    │
│   │  Repo    │          │ Branch   │        │  + Test  │                    │
│   └──────────┘          └──────────┘        └──────────┘                    │
│                                                   │                          │
│                                                   ▼                          │
│   6. DEPLOY              5. MERGE            4. PR + REVIEW                 │
│   ┌──────────┐          ┌──────────┐        ┌──────────┐                    │
│   │Production│ ◄─────── │  Main    │ ◄───── │  Code    │                    │
...
main (protected)
  │
  ├── feature/student-export ────► PR ────► merge ────► delete branch
  │
  ├── fix/login-bug ────► PR ────► merge ────► delete branch
  │
  └── docs/api-guide ────► PR ────► merge ────► delete branch
```
...
3. **Delete branches after merge** — keeps repository clean
4. **Rebase before PR** — maintain linear history
...
We follow [Conventional Commits](https://www.conventionalcommits.org/) — the same standard used by shadcn/ui, Angular, and Vue.
...
3. **Write descriptive commits** — help reviewers understand changes
4. **Respond promptly** — address feedback within 24 hours
5. **Don't take it personally** — feedback improves the code, not criticizes you

### For Reviewers

1. **Review within 24 hours** — don't block teammates
2. **Be constructive** — suggest improvements, don't criticize
3. **Explain the "why"** — help authors learn
4. **Use suggestions** — GitHub's suggestion feature for small fixes
5. **Approve when ready** — don't nitpick endlessly
...
🔗 https://hogwarts-git-feature-export-databayt.vercel.app
...
- [shadcn/ui Contributing](https://github.com/shadcn-ui/ui/blob/main/CONTRIBUTING.md) — Reference implementation
- [Vercel Deployments](https://vercel.com/docs/deployments) — Preview and production deployments
...
1. **Small, focused changes** — PRs under 500 lines
2. **Clear communication** — descriptive commits and PR descriptions
3. **Fast feedback loops** — review within 24 hours
4. **Automated quality gates** — CI/CD catches issues early
5. **Preview deployments** — test before merging
6. **Protected branches** — main is always deployable
