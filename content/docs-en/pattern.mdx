...
<div className="my-8 grid grid-cols-1 gap-6 md:grid-cols-2">
  <div className="rounded-lg border p-6">
    <h4 className="mb-2 font-semibold">Arrow Functions</h4>
    <div className="text-muted-foreground mb-4 text-sm">
      Preferred for utilities, event handlers, and inline functions. Excellent
      for maintaining lexical scope and modern JavaScript patterns.
    </div>
  ...
  <div className="rounded-lg border p-6">
    <h4 className="mb-2 font-semibold">Function Declarations</h4>
    <div className="text-muted-foreground mb-4 text-sm">
      Used for React components, API route handlers, and exported functions.
      Better for hoisting and debugging stack traces.
    </div>
    <pre className="bg-muted rounded p-2 text-xs">
