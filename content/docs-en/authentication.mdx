...
| USER      | ed.databayt.org   | `/{locale}/onboarding`                     | ✅ Implemented |
...
| TEACHER    | `teacher@databayt.org`    | `1234`   | School teacher               |
| STUDENT    | `student@databayt.org`    | `1234`   | Student access               |
| GUARDIAN   | `parent@databayt.org`     | `1234`   | Parent/guardian              |
...
│  └── "Get Started" → Login/Join → Onboarding (16 steps) → School Created        │
│                                                                                  │
...
└───────┘   └────┬────┘   └────┬────┘   └────┬────┘              └──────┬──────┘
  ...
  needed         ▼             ▼             ▼                          ▼
           ...
           │  │     NO  → Onboarding (create/join school)           │   │
           │  │     YES → Continue                                  │   │
           │  └─────────────────────────────────────────────────────┘   │
           │                             │                               │
           │                             ▼                               │
...
| School Join Codes         | 🔲 Not Started | Planned feature                         |
| Invitation System         | 🔲 Not Started | Planned feature                         |
