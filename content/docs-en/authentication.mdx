...
`demo.localhost:3000`) the login page shows a **role picker** instead of the credential
fields: pick Administrator / Teacher / Student / Parent / Accountant / Staff and press
Login. A "sign in with email instead" link reveals the normal form.
