...
| Training sessions   | $2,500-7,500/day    |
| Managed services    | $5,000-25,000/month |

### Marketplace & Partnerships

- **Integration marketplace**: 70/30 revenue split (partner/platform)
- **Template store**: $5-50 per template, subscription bundles available
- **Reseller network**: Margin-based partnership model

### Equity & Stock Sharing

All employees receive equity participation (4-year vesting, 1-year cliff). Open-source contributors earn equity through contributions with quarterly distribution events.

---

## Equity & Stock Sharing

All employees receive equity participation (4-year vesting, 1-year cliff). Open-source contributors earn equity through contributions with quarterly distribution events. Revenue allocation targets: 40% platform development, 35% team and operations, 15% marketing and sales, 10% community and open source.
