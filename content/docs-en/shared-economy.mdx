...
<div className="bg-muted/50 my-4 rounded-lg p-4 font-mono text-sm">
  <p>
    Contribution Value = (Base Points × Quality Multiplier × Impact Factor) /
    Effort Hours
  </p>
  <p className="mt-2">
    If Contribution Value is below $45/hour → Adjusted Value = $45 × Effort
    Hours
  </p>
</div>
...
**No traditional salaries.** Databayt is collectively owned by contributors. When projects come in, everyone takes their share based on contribution.

### Four Revenue Streams

| Stream         | Description                                               | Your Earnings                                     |
| -------------- | --------------------------------------------------------- | ------------------------------------------------- |
| Per Project    | Custom solutions for specific clients                     | Direct share based on project contribution        |
| Partnerships   | Outsourced tech development contracts                     | Share from contracts you help fulfill             |
| Codebase Reuse | Reusable components used across projects (highest earner) | Earn each time your indexed components are reused |
| SaaS Products  | Ready-to-deploy products sold to multiple orgs            | Ongoing royalties as products scale               |

### Expected Timeline

- **Month 1-3**: Learn systems, contribute, start earning initial shares
- **Month 6-12**: Build reusable components, participate in partnerships
- **Year 2+**: Major codebase contributor with SaaS involvement, significant recurring revenue
...
<div className="my-6 grid grid-cols-1 gap-4 md:grid-cols-2">
  <div className="rounded-lg border p-4">
    <h4 className="mb-2 font-semibold">RFC Template</h4>
    <p className="text-muted-foreground text-sm">
      Build Request for Comments template for community input and transparent
      decision-making process.
    </p>
  </div>
  <div className="rounded-lg border p-4">
    <h4 className="mb-2 font-semibold">Contribution Tracker</h4>
    <p className="text-muted-foreground text-sm">
      Create contribution tracker using GitHub Actions + SQLite to start
      measuring and recording contributions.
    </p>
  </div>
  <div className="rounded-lg border p-4">
    <h4 className="mb-2 font-semibold">Simulation</h4>
    <p className="text-muted-foreground text-sm">
      Test formulas on existing GitHub history (6 months data) to validate
      fairness and identify edge cases.
    </p>
  </div>
  <div className="rounded-lg border p-4">
    <h4 className="mb-2 font-semibold">Pilot Program</h4>
    <p className="text-muted-foreground text-sm">
      Invite 5-10 early contributors to pilot program, gather feedback, and
      iterate on the system.
    </p>
  </div>
  <div className="rounded-lg border p-4">
    <h4 className="mb-2 font-semibold">Iterate & Improve</h4>
    <p className="text-muted-foreground text-sm">
      3-month iteration cycles based on real-world feedback and contribution
      patterns.
    </p>
  </div>
  <div className="rounded-lg border p-4">
    ...
    <p className="text-muted-foreground text-sm">
      Public documentation of all decisions, formulas, and changes to build
      trust from day one.
    </p>
  </div>
</div>
