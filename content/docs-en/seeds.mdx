...
| Catalog Subjects    |      62 | Platform-wide                           |
| Catalog Chapters    |     201 |                                         |
| Catalog Lessons     |     986 | ClickView-sourced                       |
| Audit Logs          |    ~500 |                                         |
...
| ----: | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
|     0 | Global Catalog         | Catalog Subjects (62), Chapters (201), Lessons (986), images (S3/CloudFront)                                                         |
...
Re-runnable. Never duplicates. Safe in CI. For the single-language storage strategy and `getDisplayText()` helper, see [Translation](/docs/translation).
