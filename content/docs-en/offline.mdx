...
1. **Install.** On Android Chrome open `https://<school>.balqalam.com`, sign in, and tap the arrow on the app card at the top of the dashboard — Android opens the install sheet; iPhone opens the share sheet, where you pick *Add to Home Screen* (a two-step guide sits underneath). The icon carries the school's name in Arabic, opens right-to-left in the school's colour, and has no browser chrome.
