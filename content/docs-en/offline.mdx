...
1. **Install.** On Android Chrome open `https://<school>.balqalam.com`, sign in, and tap **Install** on the card at the top of the dashboard (or the browser menu → *Add to Home screen*). On iPhone use Safari: Share → *Add to Home Screen*. The icon carries the school's name in Arabic, opens right-to-left in the school's colour, and has no browser chrome.
