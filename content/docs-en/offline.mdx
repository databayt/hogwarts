...
- **Network first.** A page with a saved copy shows it when the network fails, or has not answered within four seconds, and the request keeps running to refresh the copy. The strip says which: "You're offline…" or "Slow connection — showing the last saved copy of this page", with Retry.
