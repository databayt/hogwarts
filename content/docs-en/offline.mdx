...
1. **Install.** On Android Chrome open `https://<school>.balqalam.com`, sign in, and tap **Download app** on the card at the top of the dashboard — Android opens the install sheet; iPhone (and any browser without an install prompt) gets a two-step guide: Share → *Add to Home Screen*. The icon carries the school's name in Arabic, opens right-to-left in the school's colour, and has no browser chrome.
