...
import { ASSIGNMENT_EXPORT_COLUMNS } from "@/components/platform/listings/assignments/columns/export"
// Classes
import { CLASS_EXPORT_COLUMNS } from "@/components/platform/listings/classes/columns/export"
import { STUDENT_EXPORT_COLUMNS } from "@/components/platform/listings/students/columns/export"
// Teachers
import { TEACHER_EXPORT_COLUMNS } from "@/components/platform/listings/teachers/columns/export"
```

**Example: Student Export Columns**

```tsx
// src/components/school-dashboard/listings/students/columns/export.ts
...
export const STUDENT_EXPORT_COLUMNS: ExportColumn<StudentExportData>[] = [
  ...
  },
  {
    ...
    format: (value, _row, locale) => {
      ...
      const g = genderMap[String(value)] || {
        en: String(value),
        ar: String(value),
      }
...
```tsx
import { commonSchemas, commonValidators } from "@/components/file"
...
```tsx
import { NoPrint, PageBreak, PrintArea, PrintButton } from "@/components/file"
...
| `src/components/school-dashboard/shared/export-button.tsx` | Deprecated      | Use `ExportButton` from File module     |
