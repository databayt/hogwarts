...
import type { ClassRef, SeedPrisma, SubjectRef, TeacherRef } from "./types"
...
const MATH_LESSONS: LessonTemplate[] = [
  {
    ...
    objectives:
      "فهم المتغيرات والتعبيرات الجبرية | Understand variables and algebraic expressions",
    materials: "Textbook Ch.1, Algebra tiles, Whiteboard, Graphing calculator",
    activities:
      "Direct instruction (15 min), Guided practice (20 min), Pair work on variable expressions (15 min), Exit ticket (5 min)",
  ...
  },
  {
    ...
    objectives:
      "حل معادلات من الدرجة الأولى في متغير واحد | Solve first-degree equations in one variable",
    materials:
      "Equation balance model, Practice worksheets, Whiteboard markers",
    activities:
      "Warm-up review (5 min), Balance method demonstration (15 min), Guided examples (15 min), Independent practice (15 min), Wrap-up (5 min)",
  ...
  },
  {
    ...
    objectives:
      "التمييز بين الدوال والعلاقات | Distinguish between functions and relations, Use function notation",
    materials:
      "Function machines manipulatives, Graphing paper, Colored markers",
    activities:
      "Function machine activity (10 min), Vertical line test exploration (15 min), Mapping diagrams (15 min), Group challenge (10 min)",
  ...
  },
  {
    ...
    objectives:
      "تصنيف المثلثات وحساب الزوايا | Classify triangles and calculate angles",
    materials: "Protractors, Rulers, Triangle cutouts, GeoGebra software",
    activities:
      "Angle measurement practice (10 min), Triangle classification activity (15 min), Angle sum theorem discovery (15 min), Problem solving (15 min)",
  ...
  },
  {
    ...
    objectives:
      "تطبيق نظرية فيثاغورس لحل المسائل | Apply Pythagorean theorem to solve problems",
    materials:
      "Grid paper, Square tiles, Calculators, Real-world problem cards",
    activities:
      "Theorem proof exploration (15 min), Guided examples (10 min), Real-world applications (15 min), Problem stations (10 min)",
  ...
  },
  {
    ...
    objectives:
      "فهم مفهوم المشتقة وقواعد الاشتقاق | Understand derivative concept and differentiation rules",
    materials:
      "Graphing calculators, Limit definition handout, Derivative rules chart",
    activities:
      "Limit definition review (10 min), Power rule introduction (15 min), Chain rule examples (15 min), Practice problems (15 min)",
  ...
  },
  {
    ...
    objectives:
      "حساب التكاملات المحددة وغير المحددة | Calculate definite and indefinite integrals",
    materials:
      "Area under curve visualizations, Integration tables, Calculators",
    activities:
      "Riemann sums demonstration (10 min), Basic integration rules (15 min), Substitution method (15 min), Practice (15 min)",
  ...
  },
  {
    ...
    objectives:
      "حساب الاحتمالات البسيطة والمركبة | Calculate simple and compound probabilities",
    materials: "Dice, Coins, Probability spinners, Tree diagram templates",
    activities:
      "Probability experiments (15 min), Tree diagrams (15 min), Compound events (10 min), Real-world applications (10 min)",
...
const ARABIC_LESSONS: LessonTemplate[] = [
  {
    ...
    objectives:
      "تحديد المبتدأ والخبر في الجملة الاسمية | Identify subject and predicate in nominal sentences",
    materials: "النحو الواضح كتاب، بطاقات الجمل، السبورة",
    activities:
      "مراجعة سريعة (5 د)، شرح القاعدة (15 د)، تطبيق جماعي (15 د)، تدريب فردي (15 د)، تلخيص (5 د)",
  ...
  },
  {
    ...
    objectives:
      "تصريف الأفعال في الأزمنة المختلفة | Conjugate verbs in different tenses",
    materials: "جداول التصريف، بطاقات الأفعال، أوراق العمل",
    activities:
      "استعراض الأزمنة (10 د)، تطبيق على الأفعال الصحيحة (15 د)، الأفعال المعتلة (15 د)، تمارين (10 د)",
  ...
  },
  {
    ...
    objectives:
      "التمييز بين التشبيه والاستعارة | Distinguish between simile and metaphor in Arabic literature",
    materials: "نصوص أدبية، أمثلة من القرآن والشعر، أوراق تحليل",
    activities:
      "قراءة نصوص (10 د)، تحليل الأمثلة (15 د)، تطبيق عملي (15 د)، كتابة إبداعية (15 د)",
  ...
  },
  {
    ...
    objectives:
      "تحليل خصائص الشعر الجاهلي | Analyze characteristics of pre-Islamic Arabic poetry",
    materials: "ديوان المعلقات، تسجيلات صوتية، خرائط ذهنية",
    activities:
      "استماع لقصيدة (5 د)، تحليل البنية (15 د)، دراسة الصور الشعرية (15 د)، مناقشة (15 د)",
  ...
  },
  {
    ...
    objectives:
      "كتابة الهمزة المتوسطة بشكل صحيح | Write medial hamza correctly in Arabic words",
    materials: "قواعد الهمزة، أوراق إملاء، بطاقات كلمات",
    activities:
      "مراجعة القاعدة (10 د)، أمثلة تفصيلية (15 د)، إملاء تدريبي (15 د)، تصحيح ذاتي (10 د)",
  ...
  },
  {
    ...
    objectives:
      "كتابة مقال منظم ومترابط | Write an organized and coherent essay",
    materials: "نماذج مقالات، قوالب كتابة، معايير التقييم",
    activities:
      "تحليل نموذج (10 د)، العصف الذهني (10 د)، كتابة المسودة (20 د)، مراجعة الأقران (10 د)",
...
const ENGLISH_LESSONS: LessonTemplate[] = [
  {
    ...
    materials:
      "Grammar textbook, Timeline visuals, Practice worksheets, Interactive whiteboard",
    activities:
      "Warm-up review (5 min), Tense introduction with timeline (15 min), Guided practice (15 min), Speaking activity (10 min), Written practice (10 min)",
  ...
  },
  {
    ...
    objectives:
      "Apply analytical reading strategies to extract main ideas and supporting details",
    materials:
      "Reading passage handouts, Annotation guides, Graphic organizers",
    activities:
      "Pre-reading vocabulary (5 min), First reading (10 min), Annotation practice (15 min), Discussion (10 min), Comprehension questions (15 min)",
  ...
  },
  {
    ...
    materials:
      "Essay outline template, Model essays, Transition word list, Rubric",
    activities:
      "Model essay analysis (10 min), Outline creation (15 min), Drafting introduction (15 min), Peer feedback (10 min), Revision (5 min)",
  ...
  },
  {
    ...
    objectives:
      "Analyze themes, characters, and literary devices in Romeo and Juliet",
    materials:
      "Play text, Character analysis chart, Theme tracker, Video clips",
    activities:
      "Scene reading (15 min), Character analysis (15 min), Theme discussion (10 min), Modern connections (10 min), Reflection (5 min)",
  ...
  },
  {
    ...
    materials:
      "Vocabulary list, Context clues worksheet, Flashcards, Dictionary",
    activities:
      "Word introduction (10 min), Context practice (15 min), Vocabulary games (15 min), Sentence writing (10 min), Review (5 min)",
  ...
  },
  {
    ...
    materials:
      "Presentation rubric, Speaking tips handout, Timer, Evaluation forms",
    activities:
      "Tips review (5 min), Mini presentations (30 min), Peer feedback (10 min), Self-reflection (10 min)",
...
const PHYSICS_LESSONS: LessonTemplate[] = [
  {
    ...
    objectives:
      "فهم وتطبيق قوانين نيوتن الثلاثة | Understand and apply Newton's three laws of motion",
    materials: "Air track, Force sensors, Motion detectors, Lab notebooks",
    activities:
      "Demonstration (10 min), First law exploration (10 min), Second law experiment (15 min), Third law activity (10 min), Problem solving (10 min)",
  ...
  },
  {
    ...
    objectives:
      "حساب الشغل والطاقة الحركية والكامنة | Calculate work, kinetic and potential energy",
    materials: "Spring scales, Ramps, Masses, Energy transfer simulation",
    activities:
      "Energy types review (5 min), Work calculation (15 min), KE and PE experiments (20 min), Energy conservation (10 min), Problems (5 min)",
  ...
  },
  {
    ...
    objectives:
      "بناء وتحليل الدوائر الكهربائية | Build and analyze electric circuits",
    materials: "Circuit boards, Resistors, Batteries, Multimeters, Bulbs",
    activities:
      "Circuit components review (5 min), Series circuit building (15 min), Parallel circuit building (15 min), Analysis and calculations (15 min), Clean up (5 min)",
  ...
  },
  {
    ...
    objectives:
      "فهم خصائص الموجات والصوت | Understand wave properties and sound",
    materials: "Tuning forks, Oscilloscope, Slinky, Sound level meter",
    activities:
      "Wave properties demonstration (10 min), Frequency and wavelength (15 min), Sound experiments (15 min), Applications (10 min), Summary (5 min)",
  ...
  },
  {
    ...
    objectives:
      "تطبيق قوانين الانعكاس والانكسار | Apply laws of reflection and refraction",
    materials: "Mirrors, Lenses, Laser pointers, Protractors, Ray boxes",
    activities:
      "Reflection law demo (10 min), Mirror experiments (15 min), Refraction intro (10 min), Snell's law application (15 min), Review (5 min)",
...
const CHEMISTRY_LESSONS: LessonTemplate[] = [
  {
    ...
    objectives:
      "فهم تنظيم الجدول الدوري والاتجاهات الدورية | Understand periodic table organization and trends",
    materials:
      "Periodic table posters, Element cards, Trend graphs, Interactive software",
    activities:
      "Table structure review (10 min), Group properties (15 min), Periodic trends (15 min), Element prediction (10 min), Summary (5 min)",
  ...
  },
  {
    ...
    objectives:
      "التمييز بين أنواع الروابط الكيميائية | Distinguish between types of chemical bonds",
    materials:
      "Molecular models, Electronegativity charts, Lewis structure templates",
    activities:
      "Bond types introduction (10 min), Ionic bonding (10 min), Covalent bonding (10 min), Metallic bonding (10 min), Model building (10 min)",
  ...
  },
  {
    ...
    objectives:
      "موازنة المعادلات الكيميائية وتصنيف التفاعلات | Balance equations and classify reactions",
    materials: "Reaction demonstrations, Equation cards, Balancing worksheets",
    activities:
      "Equation balancing review (10 min), Reaction types (15 min), Classification practice (15 min), Demonstrations (10 min), Problems (5 min)",
  ...
  },
  {
    ...
    objectives:
      "حساب تركيز المحاليل بوحدات مختلفة | Calculate solution concentration in various units",
    materials:
      "Volumetric flasks, Analytical balance, Graduated cylinders, Solutions",
    activities:
      "Concentration units review (10 min), Molarity calculations (15 min), Dilution practice (15 min), Lab preparation (10 min), Clean up (5 min)",
  ...
  },
  {
    ...
    objectives:
      "فهم خصائص الأحماض والقواعد ومقياس الأس الهيدروجيني | Understand acid-base properties and pH scale",
    materials: "pH meters, Indicators, Acid and base samples, pH paper",
    activities:
      "Acid-base properties (10 min), pH scale introduction (10 min), Indicator testing (15 min), pH calculations (10 min), Applications (10 min)",
...
const BIOLOGY_LESSONS: LessonTemplate[] = [
  {
    ...
    objectives:
      "تحديد العضيات الخلوية ووظائفها | Identify cell organelles and their functions",
    materials: "Microscopes, Prepared slides, Cell model, Diagrams",
    activities:
      "Cell theory review (5 min), Organelle overview (15 min), Microscope observation (20 min), Diagram labeling (10 min), Summary (5 min)",
    assessment:
      "Cell diagram quiz, Microscope practical, Organelle functions test",
  ...
  },
  {
    ...
    objectives:
      "وصف مراحل الانقسام المتساوي والاختزالي | Describe stages of mitosis and meiosis",
    materials:
      "Cell division models, Chromosome kits, Animation videos, Worksheets",
    activities:
      "Mitosis overview (15 min), Stage identification (10 min), Meiosis comparison (15 min), Chromosome modeling (10 min), Review (5 min)",
  ...
  },
  {
    ...
    objectives:
      "تطبيق قوانين مندل لحل مسائل الوراثة | Apply Mendel's laws to solve genetics problems",
    materials: "Punnett square templates, Genetics simulation, Trait cards",
    activities:
      "Mendel's experiments (10 min), Punnett squares (15 min), Dihybrid crosses (15 min), Problem solving (10 min), Summary (5 min)",
  ...
  },
  {
    ...
    objectives:
      "وصف مراحل التنفس الخلوي وإنتاج الطاقة | Describe cellular respiration stages and energy production",
    materials:
      "Respiration diagrams, ATP models, Respirometer, Mitochondria model",
    activities:
      "Glycolysis overview (10 min), Krebs cycle (10 min), Electron transport (10 min), ATP calculation (10 min), Respiration lab (15 min)",
  ...
  },
  {
    ...
    objectives:
      "فهم العلاقات في النظام البيئي | Understand relationships in ecosystems",
    materials:
      "Ecosystem models, Food web cards, Population graphs, Field guides",
    activities:
      "Ecosystem components (10 min), Food webs (15 min), Population dynamics (15 min), Ecological relationships (10 min), Case study (5 min)",
...
const ISLAMIC_LESSONS: LessonTemplate[] = [
  {
    title:
      "التجويد: أحكام النون الساكنة والتنوين | Tajweed: Noon Sakinah Rules",
    objectives:
      "إتقان أحكام النون الساكنة والتنوين | Master the rules of noon sakinah and tanween",
    materials: "المصحف، جدول الأحكام، تسجيلات صوتية",
    activities:
      "مراجعة الحروف (5 د)، الإظهار (10 د)، الإدغام (10 د)، الإقلاب والإخفاء (10 د)، تطبيق (15 د)، تلخيص (5 د)",
  ...
  {
    title:
      "الفقه: أركان الصلاة وواجباتها | Fiqh: Pillars and Obligations of Prayer",
    objectives:
      "التمييز بين أركان الصلاة وواجباتها وسننها | Distinguish between pillars, obligations, and sunnahs of prayer",
    materials: "كتاب الفقه، مخطط الأركان، بطاقات تصنيف",
    activities:
      "مراجعة (5 د)، الأركان (15 د)، الواجبات (15 د)، السنن (10 د)، تطبيق عملي (10 د)",
  ...
  },
  {
    ...
    objectives:
      "دراسة أحداث غزوة بدر ودروسها | Study the events and lessons of Battle of Badr",
    materials: "خرائط المعركة، كتب السيرة، عروض تقديمية",
    activities:
      "مقدمة تاريخية (10 د)، أسباب الغزوة (10 د)، أحداث المعركة (15 د)، النتائج والدروس (15 د)، مناقشة (5 د)",
  ...
  },
  {
    ...
    objectives:
      "فهم أركان الإيمان الستة بالأدلة | Understand the six pillars of faith with evidence",
    materials: "كتاب العقيدة، آيات قرآنية، أحاديث نبوية",
    activities:
      "مقدمة (5 د)، الإيمان بالله (10 د)، الملائكة والكتب والرسل (15 د)، اليوم الآخر والقدر (15 د)، تلخيص (10 د)",
  ...
  },
  {
    ...
    objectives:
      "تفسير آيات من سورة يوسف واستخراج العبر | Interpret verses from Surah Yusuf and extract lessons",
    materials: "المصحف، كتب التفسير، خرائط القصة",
    activities:
      "تلاوة الآيات (10 د)، تفسير المفردات (10 د)، شرح المعاني (15 د)، الدروس والعبر (15 د)، مناقشة (5 د)",
...
const CS_LESSONS: LessonTemplate[] = [
  {
    ...
    objectives:
      "فهم أساسيات البرمجة وكتابة البرامج البسيطة | Understand programming basics and write simple programs",
    materials: "Computers, Python IDE, Online compiler, Tutorial slides",
    activities:
      "What is programming (10 min), Python setup (10 min), First program (15 min), Variables practice (15 min), Q&A (5 min)",
  ...
  },
  {
    ...
    objectives:
      "استخدام القوائم لتخزين ومعالجة البيانات | Use lists to store and manipulate data",
    materials: "IDE, List operations reference, Practice problems",
    activities:
      "List introduction (10 min), Creating and accessing (15 min), List methods (15 min), Practice problems (10 min), Review (5 min)",
  ...
  },
  {
    ...
    objectives:
      "تنفيذ خوارزميات البحث والترتيب | Implement search and sorting algorithms",
    materials: "Algorithm visualizations, Code templates, Complexity charts",
    activities:
      "Linear search (10 min), Binary search (10 min), Bubble sort (10 min), Selection sort (10 min), Comparison (10 min), Practice (5 min)",
  ...
  },
  {
    ...
    activities:
      "Database concepts (10 min), SELECT statements (15 min), WHERE clause (10 min), JOIN introduction (10 min), Practice (10 min)",
  ...
  },
  {
    ...
    objectives:
      "إنشاء صفحات ويب باستخدام HTML وتنسيقها بـ CSS | Create web pages using HTML and style with CSS",
    materials: "Code editor, Browser, HTML/CSS reference, Design templates",
    activities:
      "HTML structure (10 min), Common tags (10 min), CSS introduction (10 min), Styling practice (15 min), Mini project (10 min)",
...
const HISTORY_GEOGRAPHY_LESSONS: LessonTemplate[] = [
  {
    ...
    objectives:
      "فهم حضارة كوش وإنجازاتها | Understand Kush civilization and achievements",
    materials: "خرائط تاريخية، صور آثار، فيديوهات وثائقية",
    activities:
      "مقدمة جغرافية (10 د)، نشأة المملكة (10 د)، العلاقة مع مصر (10 د)، الإنجازات (10 د)، السقوط (10 د)، مناقشة (5 د)",
  ...
  {
    title:
      "جغرافيا السودان: المناخ والموارد | Sudan Geography: Climate and Resources",
    objectives:
      "فهم المناخ والموارد الطبيعية في السودان | Understand Sudan's climate and natural resources",
    materials: "خرائط مناخية، رسوم بيانية، صور أقمار صناعية",
    activities:
      "المناطق المناخية (10 د)، الأنهار والمياه (10 د)، الموارد المعدنية (10 د)، الزراعة (10 د)، التحديات (10 د)، تلخيص (5 د)",
  ...
  {
    title:
      "التاريخ الإسلامي: الخلافة الراشدة | Islamic History: Rashidun Caliphate",
    objectives:
      "دراسة فترة الخلافة الراشدة وإنجازاتها | Study the Rashidun Caliphate period and achievements",
    materials: "كتب التاريخ، خرائط الفتوحات، جداول زمنية",
    activities:
      "أبو بكر الصديق (10 د)، عمر بن الخطاب (10 د)، عثمان بن عفان (10 د)، علي بن أبي طالب (10 د)، الإنجازات (10 د)، مناقشة (5 د)",
  ...
  },
  {
    ...
    objectives:
      "تحديد وشرح أنواع التضاريس المختلفة | Identify and explain different landform types",
    materials: "نماذج تضاريس، خرائط طبوغرافية، صور جوية",
    activities:
      "الجبال والهضاب (10 د)، السهول والوديان (10 د)، التضاريس الساحلية (10 د)، قراءة الخرائط (10 د)، تطبيق (10 د)، مراجعة (5 د)",
...
const ALL_LESSONS: { subject: string; lessons: LessonTemplate[] }[] = [
  ...
  {
    subject: "Geography",
    lessons: HISTORY_GEOGRAPHY_LESSONS.slice(1, 2).concat(
      HISTORY_GEOGRAPHY_LESSONS.slice(3)
    ),
  },
  {
    subject: "History",
    lessons: HISTORY_GEOGRAPHY_LESSONS.filter((_, i) => i === 0 || i === 2),
  },
]
...
export async function seedLessons(
  ...
  for (const cls of classesWithSubject) {
    const subjName =
      allSubjects.find((s) => s.id === cls.subjectId)?.subjectName || ""
  ...
  for (const { subject, lessons } of ALL_LESSONS) {
    const subjectClasses =
      classBySubject.get(subject) || classesWithSubject.slice(0, 3)

    if (subjectClasses.length === 0) {
      // If no classes found for this subject, use any available classes
      const fallbackClasses = classesWithSubject.slice(
        lessonCount % Math.min(5, classesWithSubject.length),
        (lessonCount % Math.min(5, classesWithSubject.length)) + 1
      )
  ...
  const inProgressCount = lessonRecords.filter(
    (l) => l.status === LessonStatus.IN_PROGRESS
  ).length
  const plannedCount = lessonRecords.filter(
    (l) => l.status === LessonStatus.PLANNED
  ).length
  ...
  console.log(
    `      - Features: Bilingual content, detailed materials, activities, assessments, homework\n`
  )
}
