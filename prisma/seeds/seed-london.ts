...
/**
 * لندن (London) Tenant Seed — الخرطوم
 *
 ...
 *   https://london.balqalam.com    http://london.localhost:3000 (dev)
 ...
 * Usage:
 *   pnpm db:seed:london
 *   tsx prisma/seeds/seed-london.ts
 */
...
const LOGO_PATH = join(__dirname, "assets", "london-logo.png")
...
async function uploadLogo(schoolId: string) {
  ...
  const key = `${schoolId}/logos/london-logo-${digest}.png`
  ...
  await client.send(
    new PutObjectCommand({
      ...
      Metadata: { schoolId, originalName: "london-logo.png" },
    })
  )
...
async function upsertTranslations(schoolId: string) {
  ...
  const pairs = [
    { ar: "لندن", en: "London" },
    { ar: "مدارس لندن", en: "London Schools" },
    { ar: "إدارة لندن", en: "London Administration" },
    { ar: "زائر لندن", en: "London Visitor" },
  ]
  ...
  console.log("  ✅ London translations configured")
}
...
async function main() {
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  console.log("🏫 لندن — London Tenant Setup")
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  ...
  // --- Accounts ---
  console.log("\n👥 School accounts...")
  await upsertSchoolUser(ADMIN_EMAIL, "إدارة لندن", "ADMIN", schoolId)
  ...
  console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  console.log("✅ London tenant ready")
  console.log("")
  console.log("  https://london.balqalam.com/ar")
  console.log("  http://london.localhost:3000/ar   (dev)")
  console.log("")
