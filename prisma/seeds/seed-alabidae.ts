...
/**
 * الابداع (Alabidae) Tenant Seed — الخرطوم
 *
 ...
 *   https://alabidae.balqalam.com    http://alabidae.localhost:3000 (dev)
 * NOT databayt.org — that root now serves a different application entirely,
 * despite still being registered in ROOT_DOMAINS.
 *
 * Like seed-alqabs.ts and unlike seed-kingfahad.ts this does NOT hand-roll the
 * academic structure — it drives the production provisioning pipeline
 * (setupDefaultsForSchool → setupCatalogForSchool → repairProvisioning), so the
 * tenant is identical to one created through onboarding and picks up the SD
 * national curriculum from School.country alone.
 *
 * Idempotent — safe to re-run.
 *
 * Usage:
 *   pnpm db:seed:alabidae
 *   tsx prisma/seeds/seed-alabidae.ts
 */
...
const PASSWORD = "1234"
const DOMAIN = "alabidae"
const EMAIL_DOMAIN = "alabidae.com"
  ...
  if (!student) {
    student = await db.student.create({
      data: {
        ...
        lastName: "مكي",
        lang: "ar",
        dateOfBirth: new Date("2013-01-27"),
        gender: "female",
        nationality: "SD",
        email: STUDENT_EMAIL,
        city: "الخرطوم",
...
const LOGO_PATH = join(__dirname, "assets", "alabidae-logo.png")
...
async function uploadLogo(schoolId: string) {
  ...
  const key = `${schoolId}/logos/alabidae-logo-${digest}.png`
  ...
  await client.send(
    new PutObjectCommand({
      ...
      Metadata: { schoolId, originalName: "alabidae-logo.png" },
    })
  )
...
async function upsertTranslations(schoolId: string) {
  console.log("\n🌐 Translations...")
  const pairs = [
    { ar: "الابداع", en: "Alabidae" },
    { ar: "مدارس الابداع", en: "Alabidae Schools" },
    { ar: "إدارة الابداع", en: "Alabidae Administration" },
    { ar: "زائر الابداع", en: "Alabidae Visitor" },
  ]
  ...
  console.log("  ✅ Alabidae translations configured")
}
...
async function main() {
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  console.log("🏫 الابداع — Alabidae Tenant Setup")
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  ...
  // --- Accounts ---
  console.log("\n👥 School accounts...")
  await upsertSchoolUser(ADMIN_EMAIL, "إدارة الابداع", "ADMIN", schoolId)
  ...
  console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  console.log("✅ Alabidae tenant ready")
  console.log("")
  console.log("  https://alabidae.balqalam.com/ar")
  console.log("  http://alabidae.localhost:3000/ar   (dev)")
  console.log("")
