...
const STAFF_POSITIONS: StaffPosition[] = [
  ...
  {
    titleEn: "Vice Principal - Academic",
    titleAr: "نائب المدير - الشؤون الأكاديمية",
    department: "Administration",
    count: 1,
    gender: "any",
    salaryRange: [120000, 150000],
    qualifications: ["Master's in Education", "10+ years experience"],
  },
  {
    titleEn: "Vice Principal - Student Affairs",
    titleAr: "نائب المدير - شؤون الطلاب",
    department: "Administration",
    count: 1,
    gender: "any",
    salaryRange: [120000, 150000],
  ...
  {
    titleEn: "Administrative Secretary",
    titleAr: "سكرتير إداري",
    department: "Administration",
    count: 3,
    gender: "any",
  ...
  },
  {
    ...
    qualifications: ["Bachelor's degree", "Experience in student records"],
  },
  {
    ...
    qualifications: ["Bachelor's degree", "Communication skills"],
  },
  ...
  // Finance
  {
    ...
    qualifications: ["Bachelor's in Accounting", "CPA certification"],
  },
  {
    titleEn: "Accountant",
    titleAr: "محاسب",
  ...
  // Student Support
  {
    ...
    titleAr: "ممرضة المدرسة",
    department: "Health",
    count: 2,
    gender: "F",
    salaryRange: [50000, 70000],
    qualifications: ["Nursing Diploma", "First Aid certification"],
  },
  {
    ...
    qualifications: ["Bachelor's in Psychology", "Counseling certification"],
  },
  {
    ...
    qualifications: ["Bachelor's in Social Work"],
  },
  {
    titleEn: "Special Education Coordinator",
    titleAr: "منسق التربية الخاصة",
    department: "Student Services",
    count: 1,
    gender: "any",
    salaryRange: [65000, 85000],
    qualifications: ["Master's in Special Education"],
  },

  // Library
  {
    titleEn: "Head Librarian",
    titleAr: "أمين المكتبة الرئيسي",
    department: "Library",
    count: 1,
    gender: "any",
    salaryRange: [60000, 80000],
  ...
  {
    titleEn: "Assistant Librarian",
    titleAr: "مساعد أمين المكتبة",
    department: "Library",
    count: 2,
    gender: "any",
  ...
  // Laboratory
  {
    titleEn: "Science Lab Technician",
    titleAr: "فني معمل العلوم",
    department: "Laboratory",
    count: 2,
    gender: "any",
    salaryRange: [45000, 60000],
    qualifications: ["Diploma in Laboratory Technology"],
  },
  {
    titleEn: "Computer Lab Technician",
    titleAr: "فني معمل الحاسوب",
    department: "IT",
    count: 2,
    gender: "any",
    salaryRange: [50000, 70000],
  ...
  // IT
  {
    ...
    qualifications: ["Bachelor's in IT", "Network certification"],
  },
  {
    titleEn: "IT Support Technician",
    titleAr: "فني دعم تقنية المعلومات",
    department: "IT",
    count: 2,
    gender: "any",
    salaryRange: [45000, 65000],
  ...
  // Security
  {
    ...
    gender: "M",
    salaryRange: [40000, 55000],
    qualifications: ["Security training", "5+ years experience"],
  },
  {
    ...
    qualifications: ["Security training"],
  },
  {
    titleEn: "Gate Keeper",
    titleAr: "حارس البوابة",
    department: "Security",
    count: 2,
    gender: "M",
  ...
  // Maintenance
  {
    titleEn: "Maintenance Supervisor",
    titleAr: "مشرف الصيانة",
    department: "Maintenance",
    count: 1,
    gender: "M",
    salaryRange: [45000, 60000],
    qualifications: ["Technical diploma", "5+ years experience"],
  },
  {
    titleEn: "Electrician",
    titleAr: "كهربائي",
  ...
  {
    titleEn: "General Maintenance Worker",
    titleAr: "عامل صيانة عام",
    department: "Maintenance",
    count: 2,
    gender: "M",
    salaryRange: [25000, 35000],
  ...
  // Cleaning
  {
    titleEn: "Cleaning Supervisor",
    titleAr: "مشرف النظافة",
  ...
  // Cafeteria
  {
    titleEn: "Cafeteria Manager",
    titleAr: "مدير المقصف",
    department: "Cafeteria",
    count: 1,
    gender: "any",
    salaryRange: [40000, 55000],
    qualifications: ["Food service management"],
  },
  {
    titleEn: "Cook",
    titleAr: "طباخ",
    ...
    gender: "any",
    salaryRange: [25000, 35000],
    qualifications: ["Cooking experience", "Food safety training"],
  },
  {
  ...
  },
  {
    ...
    gender: "M",
    salaryRange: [30000, 40000],
    qualifications: ["Commercial driving license", "Clean record"],
  },
  {
    titleEn: "Bus Monitor",
    titleAr: "مراقب الحافلة",
    department: "Transportation",
    count: 4,
    gender: "F",
    salaryRange: [20000, 28000],
    qualifications: ["Child care experience"],
  },
]
...
export async function seedStaff(
  ...
  if (existingStaff >= 30) {
    console.log(
      `   ✅ Staff already exists (${existingStaff} members), skipping\n`
    )
    return
  }
  ...
  for (const position of STAFF_POSITIONS) {
    for (let i = 0; i < position.count; i++) {
      ...
      const surnameIndex =
        Math.floor(staffIndex / names.givenEn.length) % SURNAMES.en.length
