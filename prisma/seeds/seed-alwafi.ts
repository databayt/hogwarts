 ...
 *   https://alwafi.balqalam.com    http://alwafi.localhost:3000 (dev)
 ...
 * Usage:
 *   pnpm db:seed:alwafi
 *   tsx prisma/seeds/seed-alwafi.ts
 */
...
async function upsertSchool() {
  console.log("🏫 Alwafi school...")

  const common = {
    name: "الوافي",
    nameEn: "Alwafi",
    address: "ربك، ولاية النيل الأبيض، السودان",
    city: "ربك",
    state: "النيل الأبيض",
    country: "SD",
  ...
  if (!student) {
    student = await db.student.create({
      data: {
        ...
        lastName: "الفاضل",
        lang: "ar",
        dateOfBirth: new Date("2013-05-04"),
        gender: "female",
        nationality: "SD",
        email: STUDENT_EMAIL,
        city: "ربك",
...
const LOGO_PATH = join(__dirname, "assets", "alwafi-logo.png")
...
async function uploadLogo(schoolId: string) {
  ...
  const key = `${schoolId}/logos/alwafi-logo-${digest}.png`
  ...
  await client.send(
    new PutObjectCommand({
      ...
      Metadata: { schoolId, originalName: "alwafi-logo.png" },
    })
  )
...
async function upsertTranslations(schoolId: string) {
  ...
  const pairs = [
    { ar: "الوافي", en: "Alwafi" },
    { ar: "مدارس الوافي", en: "Alwafi Schools" },
    { ar: "إدارة الوافي", en: "Alwafi Administration" },
    { ar: "زائر الوافي", en: "Alwafi Visitor" },
  ]
  ...
  console.log("  ✅ Alwafi translations configured")
}
...
async function main() {
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  console.log("🏫 الوافي — Alwafi Tenant Setup")
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  ...
  // --- Accounts ---
  console.log("\n👥 School accounts...")
  await upsertSchoolUser(ADMIN_EMAIL, "إدارة الوافي", "ADMIN", schoolId)
  ...
  console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
  console.log("✅ Alwafi tenant ready")
  console.log("")
  console.log("  https://alwafi.balqalam.com/ar")
  console.log("  http://alwafi.localhost:3000/ar   (dev)")
  console.log("")
