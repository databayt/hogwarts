...
import type { DepartmentRef, SeedPrisma, SubjectRef } from "./types"
...
export async function seedDepartments(
  ...
  console.log(
    "📖 Creating departments and subjects (Sudanese Curriculum, Bilingual AR/EN)..."
  )
  ...
  console.log(
    `   ✅ Created: ${departments.length} departments, ${subjects.length} subjects\n`
  )
