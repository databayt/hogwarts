...
} from "@/lib/report/hard-filters"
import { reportSchema } from "@/lib/report/schema"
import { bucketFor, computeScore, THRESHOLDS } from "@/lib/report/score"
import type { AITriageResult, ReporterContext } from "@/lib/report/types"
...
describe("runHardFilters", () => {
  ...
  it("HF1: rejects under-30 descriptions", () => {
    ...
    const r = runHardFilters(
      { ...parsed, description: "Hi there friend" },
      adminReporter,
      ctx
    )
