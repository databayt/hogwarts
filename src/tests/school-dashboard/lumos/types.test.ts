...
} from "@/components/lumos/types"

describe("Lumos Types", () => {
  describe("LumosDictionary", () => {
    it("should have correct structure for lumos property", () => {
      const dict: LumosDictionary = {
        title: "Lumos LMS",
      ...
      expectTypeOf(dict).toMatchTypeOf<LumosDictionary>()
    })
  })

  describe("LumosContentProps", () => {
    it("should have correct structure", () => {
      expectTypeOf<LumosContentProps>().toHaveProperty("dictionary")
      expectTypeOf<LumosContentProps>().toHaveProperty("lang")
      expectTypeOf<LumosContentProps>().toHaveProperty("schoolId")
    })
  })
