...
import { materializeSchoolDay } from "@/components/school-dashboard/live/actions/materialize-day"
import { materializeOpenRoom } from "@/components/school-dashboard/live/actions/open-room"
import { materializeSlotSession } from "@/components/school-dashboard/live/actions/slot-session"
...
vi.mock("@/components/school-dashboard/live/online-policy", async () => {
  const actual = await vi.importActual<
    typeof import("@/components/school-dashboard/live/online-policy")
