...
const { getAccounts: getMyBankAccounts, removeBank } =
  await import("@/components/school-dashboard/finance/banking/my-banks/actions")
const { getAccounts: getTransferAccounts, getRecentTransfers } =
  await import("@/components/school-dashboard/finance/banking/payment-transfer/actions")
