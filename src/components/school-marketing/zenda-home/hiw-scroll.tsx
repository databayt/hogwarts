...
// Ported verbatim from zenda (home/hiw-scroll). Renders under the `.zenda-clone`
...
/**
 * "How it works" scroll behaviour — a faithful port of zenda.com's `hiwIntro`,
 * `hiwMarquee`, `hiwGridItems` and the mobile `marqueeIx` loops.
 *
 *  - header (`hiw-element`) rises + fades in (scrubbed),
 *  - desktop columns parallax apart on scroll: `up` columns drift up, `down`
 *    columns drift down (scrubbed),
 *  - the stats grid items rise + fade in (scrubbed),
 *  - on mobile the two stacked tracks scroll continuously (up / reverse-down).
 */
