        ...
        <section ref={containerRef} className="py-16 md:py-24">
            <div className="grid gap-8 lg:grid-cols-3 lg:gap-12 items-center">
                ...
                <div className="flex items-start gap-3">
                    <span className="text-5xl md:text-6xl font-heading text-muted-foreground/40 leading-none">"</span>
                    <p className="text-lg md:text-xl lg:text-2xl font-medium leading-relaxed pt-2">
                        {dict.quote}
                    </p>
                </div>
            </div>
