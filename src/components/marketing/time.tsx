...
const Time = ({ dictionary }: TimeProps) => {
    ...
    return (
        <section className='flex justify-between items-center px-8 md:px-10 lg:px-12 py-16 md:py-20 lg:py-24 my-40 bg-black dark:invert text-background rounded-md'>
