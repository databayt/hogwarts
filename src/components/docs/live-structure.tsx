        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              type: "file",
              description: "can the school teach online (admins only)",
            },
            {
              name: "role-guide.tsx",
              type: "file",
              description: "what THIS role can do here",
            },
            {
              name: "get-started-band.tsx",
              type: "file",
              description: "pitch + 3 setup steps, only while not yet online",
            },
            {
              name: "reveal.tsx",
              type: "file",
              description: "the one motion wrapper (get-started band only)",
            },
            {
              name: "viewer.ts",
              type: "file",
              description: "role → what the page offers (single source)",
            },
            {
              name: "types.ts",
              type: "file",
