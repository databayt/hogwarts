...
interface LumosStructureProps {
  className?: string
}

export function LumosStructure({ className }: LumosStructureProps) {
  const nodes: LumosNode[] = [
    {
      name: "src/components/lumos/",
      type: "directory",
      ...
      children: [
        {
          name: "types.ts",
          type: "file",
          description: "LumosDictionary, LumosContentProps, course types",
        },
        {
    ...
    },
    {
      ...
      children: [
        {
          name: "src/app/[lang]/s/[subdomain]/(school-dashboard)/lumos/",
          type: "directory",
        ...
        {
          name: "src/components/internationalization/lumos-{en,ar}.json",
          type: "file",
          description: "the stream dictionary subtree",
        },
        {
          name: "src/tests/school-dashboard/lumos/",
          type: "directory",
