...
import type { AvailableVideo } from "@/components/lumos/data/catalog/get-lesson-with-progress"
...
export function InstructorSwitcher({
  ...
  // Receives the `lumos` dictionary subtree from the lesson content component,
  // so descend a single level (not `?.lumos?.instructorSwitcher`).
