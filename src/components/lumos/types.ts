...
// Lumos Dictionary Types
export interface LumosFeature {
  title: string
  description: string
  icon: string
}

export interface LumosDictionary {
  title: string
  description: string
  home: {
    badge: string
...
// Base props for all Lumos content components
export interface LumosContentProps {
...
export interface LumosAuthenticatedProps extends LumosContentProps {
  userId: string
}

// Props for admin components
export interface LumosAdminProps extends LumosAuthenticatedProps {
  userRole: UserRole
}

// Props with search params
export interface LumosSearchProps {
  searchParams?: {
    category?: string
    search?: string
    page?: string
