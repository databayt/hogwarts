...
export interface VideoPlayerProps {
  ...
  //
  // Not called for a merely-expired signed URL: the player first retries a
  // protected source once by itself (see PROTECTED_URL_PREFIX in
  // video-player.tsx), because that error is routine and self-healing.
  onSourceError?: () => void
  className?: string
  autoPlay?: boolean
