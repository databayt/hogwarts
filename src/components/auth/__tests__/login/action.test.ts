...
const mockedGetTwoFactorConfirmationByUserId = vi.mocked(getTwoFactorConfirmationByUserId)
...
describe('Login Action - Email Verification', () => {
  ...
  it('should send verification email when user is not verified', async () => {
    ...
    expect(mockedGenerateVerificationToken).toHaveBeenCalledWith('unverified@example.com')
...
describe('Login Action - Error Handling', () => {
  ...
  it('should return error for invalid credentials', async () => {
    ...
    const authError = new AuthError('CredentialsSignin', { type: 'CredentialsSignin' })
