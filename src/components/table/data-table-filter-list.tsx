...
import {
  ...
  FacetedList,
  FacetedTrigger,
} from "@/components/table/atom/faceted"
import {
  Sortable,
  SortableContent,
  SortableItem,
...
function DataTableFilterListInner<TData>({
  table,
...
export const DataTableFilterList = React.memo(DataTableFilterListInner) as <
  TData,
>(
  props: DataTableFilterListProps<TData>
) => React.ReactElement
