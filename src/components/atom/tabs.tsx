...
function TabLink({ tab, isActive }: { tab: TabItem; isActive: boolean }) {
  ...
  return (
    <Link
      href={tab.href}
      key={tab.href}
      className="hover:text-primary data-[active=true]:bg-muted data-[active=true]:text-primary flex h-7 items-center justify-center rounded-full px-4 text-center transition-colors"
