    ...
    <div id="faq" className="faq" data-framer-name="FAQ">
      <motion.div className="faq-grid" {...reveal(60, 0.5)}>
        ...
        <div className="faq-col">
          ...
          <Qa q="كم تكلفة النظام؟">
            <p dir="rtl" className="faq-a">
              <Reg>
                <strong>{"مجانًا حتى 100 طالب"}</strong>
              </Reg>
              {
                "، وبعدها تتدرّج التكلفة حسب عدد الطلاب. لا رسوم إعداد، ولا عقود طويلة الأمد، ولا رسوم خفية. وللتفاصيل راجع صفحة "
              }
              <a href="/pricing" className="faq-link">
                {"الأسعار"}
              </a>
              {"."}
            </p>
