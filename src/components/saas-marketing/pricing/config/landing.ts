...
export const infos: InfoLdg[] = [
  {
    ...
    description:
      "Unlock the full potential of your projects with our open-source SaaS school-dashboard. Collaborate seamlessly, innovate effortlessly, and scale limitlessly.",
    ...
    list: [
      ...
      },
      {
        title: "Scalable",
        description:
          "Our school-dashboard offers the scalability needed to adapt to your needs.",
        icon: "search",
      },
    ],
  },
...
export const testimonials: TestimonialType[] = [
  ...
  },
  {
    ...
    review:
      "next-saas-stripe-starter has been an invaluable asset in my role as a saas-marketing manager. With its seamless integration with Stripe, I've been able to launch targeted saas-marketing campaigns with built-in payment functionality, allowing us to monetize our products and services more effectively.",
  },
  {
    name: "Jason Stan",
    job: "Web Designer",
