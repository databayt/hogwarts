 ...
 */
export function validatePersonalStep(data: PersonalStepData | undefined): boolean {
 ...
 */
export function validateContactStep(data: ContactStepData | undefined): boolean {
  if (!data) return false;
  return !!(
    data.email &&
    data.phone &&
 ...
 */
export function validateGuardianStep(data: GuardianStepData | undefined): boolean {
  if (!data) return false;
 ...
 */
export function validateAcademicStep(data: AcademicStepData | undefined): boolean {
  if (!data) return false;
 ...
 */
export function validateDocumentsStep(data: DocumentsStepData | undefined): boolean {
