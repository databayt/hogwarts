...
export function createApplicationStepSchemas(dictionary?: Dictionary) {
  ...
  return {
    ...
    personal: z.object({
      ...
      middleName: z.string().max(50, v.maxLength(50)).optional().or(z.literal("")),
    ...
    contact: z.object({
      ...
      alternatePhone: z.string().min(10, v.invalidPhone()).optional().or(z.literal("")),
    ...
    guardian: z.object({
      ...
      fatherEmail: z.string().email(v.invalidEmail()).optional().or(z.literal("")),
      ...
      motherEmail: z.string().email(v.invalidEmail()).optional().or(z.literal("")),
      guardianName: z.string().optional().or(z.literal("")),
      guardianRelation: z.string().optional().or(z.literal("")),
      guardianPhone: z.string().optional().or(z.literal("")),
      guardianEmail: z.string().email(v.invalidEmail()).optional().or(z.literal("")),
    }),
...
export function createTourBookingSchema(dictionary?: Dictionary) {
  ...
  return z.object({
    ...
    studentName: z.string().max(100, v.maxLength(100)).optional().or(z.literal("")),
    interestedGrade: z.string().optional().or(z.literal("")),
    specialRequests: z.string().max(500, v.maxLength(500)).optional().or(z.literal("")),
...
export function createInquirySchema(dictionary?: Dictionary) {
  ...
  return z.object({
    ...
    message: z.string().max(1000, v.maxLength(1000)).optional().or(z.literal("")),
...
export type CampaignFormData = z.infer<ReturnType<typeof createApplicationStepSchemas>["campaign"]>;
export type PersonalFormData = z.infer<ReturnType<typeof createApplicationStepSchemas>["personal"]>;
export type ContactFormData = z.infer<ReturnType<typeof createApplicationStepSchemas>["contact"]>;
export type GuardianFormData = z.infer<ReturnType<typeof createApplicationStepSchemas>["guardian"]>;
export type AcademicFormData = z.infer<ReturnType<typeof createApplicationStepSchemas>["academic"]>;
export type DocumentsFormData = z.infer<ReturnType<typeof createApplicationStepSchemas>["documents"]>;
export type FullApplicationFormData = z.infer<ReturnType<typeof createFullApplicationSchema>>;
export type TourBookingFormData = z.infer<ReturnType<typeof createTourBookingSchema>>;
