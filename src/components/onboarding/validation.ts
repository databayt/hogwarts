...
export const titleStepValidation = onboardingValidation
  .pick({
    name: true,
  })
  .required({
...
export const descriptionStepValidation = onboardingValidation
  .pick({
    description: true,
    schoolLevel: true,
    schoolType: true,
...
export const locationStepValidation = onboardingValidation
  .pick({
    address: true,
    city: true,
    state: true,
...
export const capacityStepValidation = onboardingValidation
  .pick({
    maxStudents: true,
    maxTeachers: true,
    maxClasses: true,
...
export const priceStepValidation = onboardingValidation
  .pick({
    tuitionFee: true,
...
export function createDomainSchema(dictionary: Dictionary) {
  ...
  return z
    ...
    .refine((val) => !val.includes("--"), {
      message: v.get("domainNoConsecutiveHyphens"),
    })
}
