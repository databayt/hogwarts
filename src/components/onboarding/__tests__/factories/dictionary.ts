...
const validationMessages = {
  ...
  domainMustStartWithLetterOrNumber: 'Domain must start with a letter or number',
  ...
  subdomainInvalidFormat: 'Only lowercase letters, numbers, and hyphens allowed',
  ...
  subdomainMustStartWithLetterOrNumber: 'Subdomain must start with a letter or number',
  subdomainMustEndWithLetterOrNumber: 'Subdomain must end with a letter or number',
