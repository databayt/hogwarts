...
describe('domainSchema', () => {
  ...
  describe('consecutive hyphen validation', () => {
    ...
    it('should reject consecutive hyphens', () => {
      ...
      expect(result.success).toBe(false)
      if (!result.success) {
        expect(result.error.issues.some(i => i.message.includes('consecutive'))).toBe(true)
      }
    })
...
describe('schoolCategorySchema', () => {
  it('should accept all valid categories', () => {
    const categories = ['private', 'public', 'international', 'technical', 'special']
...
describe('getRequiredFieldsForStep', () => {
  ...
  it('should return required fields for legal step', () => {
    ...
    expect(fields).toEqual(['termsAccepted', 'privacyAccepted', 'dataProcessingAccepted'])
  })
...
describe('Edge Cases', () => {
  describe('whitespace handling', () => {
    ...
    it('should trim whitespace from description', () => {
      ...
      expect(result.success).toBe(true)
      if (result.success) {
        expect(result.data.description).toBe('A valid description that is long enough')
      }
    })
  })
  ...
  describe('special characters', () => {
    ...
    it('should accept description with unicode', () => {
      const result = descriptionStepValidation.safeParse({
        description: 'A school with international students from around the world.',
      })
      expect(result.success).toBe(true)
    })
