...
const SchoolOnboardingDashboard: React.FC<SchoolOnboardingDashboardProps> = ({
  ...
  return (
    <>
      <div className="mx-auto w-full max-w-xl space-y-3 px-3 pb-48 sm:space-y-4 sm:px-4">
        {/* Welcome Header */}
        <div>
      ...
      <footer className="bg-background fixed right-0 bottom-0 left-0 px-4 py-3 sm:px-6 sm:py-4 md:px-12 lg:px-20">
        <div className="border-border mx-auto w-full max-w-xl border-t pt-3 sm:pt-4">
          <NewSchoolOptions
