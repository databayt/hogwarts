...
const HostFooter: React.FC<HostFooterProps> = ({
  ...
  const getCurrentStepFromPath = () => {
    ...
    const stepIndex = HOSTING_STEPS.findIndex(
  ...
  const canGoNextActual =
    canGoNext &&
    (currentStepIndex < HOSTING_STEPS.length - 1 ||
      currentStepSlug === "legal") &&
    !nextDisabled &&
    !contextNextDisabled &&
  ...
  return (
    <footer className="fixed right-0 bottom-0 left-0 bg-white">
