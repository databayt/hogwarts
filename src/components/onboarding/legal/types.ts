...
export type DocumentType = 'terms' | 'privacy' | 'safety' | 'conduct' | 'enrollment';
export type ComplianceLevel = 'required' | 'recommended' | 'optional';
export type SafetyFeature = 'background_checks' | 'cctv' | 'visitor_logs' | 'emergency_plan' | 'health_safety';
