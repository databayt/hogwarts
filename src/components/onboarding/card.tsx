...
import { ONBOARDING_STEPS, STEP_GROUPS } from "./config"
import type {
  OnboardingProgress,
  ...
  return (
    ...
    >
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h5 className="truncate">{school.name || "Unnamed School"}</h5>
            {school.description && (
      ...
      <CardContent className="space-y-4">
        {/* School Details */}
        <div className="muted grid grid-cols-1 gap-3 md:grid-cols-2">
          {school.address && (
        ...
        {/* Timestamps */}
        <div className="muted flex items-center gap-4">
          {school.createdAt && (
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Track your school setup completion</CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex justify-between">
            ...
            <p className="muted">{progress.completionPercentage}% Complete</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            {Object.entries(STEP_GROUPS).map(([groupKey, group]) => {
              const groupProgress = getGroupProgress(
                groupKey as keyof typeof STEP_GROUPS
              )
              return (
        ...
        {progress.nextStep && (
          <div className="space-y-2 border-t pt-4">
            <div className="flex items-center justify-between">
              <div>
                <h6>Next Step</h6>
                <p className="muted">{getStepTitle(progress.nextStep)}</p>
              </div>
              {onContinue && (
