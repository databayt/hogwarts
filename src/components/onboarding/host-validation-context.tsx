...
const HostValidationContext = createContext<
  HostValidationContextType | undefined
>(undefined)
...
export const useHostValidation = () => {
  ...
  if (!context) {
    throw new Error(
      "useHostValidation must be used within a HostValidationProvider"
    )
  }
  return context
}
...
export const HostValidationProvider: React.FC<HostValidationProviderProps> = ({
  children,
}) => {
