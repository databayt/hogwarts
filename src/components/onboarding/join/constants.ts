...
export const JOIN_OPTIONS: JoinOption[] = [
  {
    ...
    description: 'Generate invitation codes that teachers, staff, students and parents can use to self-register. You can review and approve.',
    recommended: true,
  },
  {
...
export const ROLE_CONFIGS: Record<UserRole, { name: string; description: string; defaultLimit: number }> = {
  teacher: {
    name: 'Teachers',
...
export const JOIN_MESSAGES = {
  ...
  ROLE_LIMIT_REACHED: 'You have reached the maximum number of users for this role',
  PARENT_APPROVAL_REQUIRED: 'Parent approval is required for student registration',
