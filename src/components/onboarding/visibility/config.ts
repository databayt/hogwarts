import { SharingOption, VisibilityOption, AccessOption } from './types';
...
export const VISIBILITY_OPTIONS: VisibilityOption[] = [
  {
    id: 'public',
    title: 'Public',
    description: 'Your school will be visible in search results and the school directory.',
    recommended: true,
  },
  {
    id: 'private',
...
export const ACCESS_OPTIONS: AccessOption[] = [
  ...
  },
  {
    ...
    requirements: ['Admin approval', 'Identity verification', 'Role assignment'],
  },
] as const;
...
export const VISIBILITY_MESSAGES = {
  ...
  PARENT_APPROVAL_WARNING: 'Disabling parent approval may affect student privacy',
  PUBLIC_DIRECTORY_WARNING: 'Public directory listing may expose school information',
  SELF_ENROLLMENT_WARNING: 'Self-enrollment requires additional verification measures',
} as const;
