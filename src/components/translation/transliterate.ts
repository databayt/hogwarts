 ...
 *
 * @example
 * formatName("محمد", "علي", "en") // "Mohammed Ali"
 * formatName("محمد", "علي", "ar") // "محمد علي"
 */
 ...
 *
 * @example
 * transliterate("محمد علي", "en") // "Mohammed Ali"
 * transliterate("محمد علي", "ar") // "محمد علي"
 */
export function transliterate(fullName: string, lang: Locale): string {
  if (!fullName) return ""
