...
import { markAttendance } from '@/components/school/dashboard/attendance/actions'
...
import { getAttendanceList, getClassesForSelection, getAttendanceReportCsv } from '@/components/school/dashboard/attendance/actions'
