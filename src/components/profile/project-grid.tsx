  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {projects.map((project, index) => (
        <div key={index} className="bg-[#212830] border border-[#3d444d] rounded-lg p-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <span className="text-xs text-[#9198a1] border border-[#3d444d] rounded-full px-2 py-1">
              {project.type}
            </span>
          </div>

          <p className="text-[#9198a1] text-sm mb-3 line-clamp-2">{project.description}</p>

          <div className="flex items-center justify-between text-xs text-[#9198a1]">
