  ...
  const projects = [
    {
      ...
      description:
        "Interactive 3D model of the solar system with planetary motion simulation and educational content.",
      subject: "Physics",
      grade: "A+",
      status: "Completed",
    },
    {
      ...
      type: "Programming",
      description:
        "Mobile application for students to track assignments, grades, and communicate with teachers.",
    ...
    },
    {
      ...
      type: "Lab Report",
      description:
        "Comprehensive analysis of acid-base reactions with detailed observations and conclusions.",
      subject: "Chemistry",
      grade: "A-",
      status: "Completed",
    },
    {
      ...
      type: "Essay",
      description:
        "Critical analysis of themes and character development in contemporary literature.",
      subject: "English",
      grade: "B+",
      status: "Completed",
    },
    {
      ...
      description:
        "Interactive timeline of major historical events with multimedia presentations.",
      subject: "History",
      grade: "A",
      status: "Completed",
    },
    {
      ...
      type: "Study Group",
      description:
        "Collaborative preparation materials and practice problems for upcoming mathematics competition.",
      subject: "Mathematics",
      grade: "Ongoing",
      status: "Active",
    },
      ...
      {projects.map((project, index) => (
        ...
        >
          <div className="mb-2 flex items-start justify-between">
            ...
            <span className="muted border-border rounded-full border px-2 py-1">
              {project.type}
            </span>
          </div>
          ...
          <div className="muted flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center">
                <span
                  className={`muted rounded-full px-2 py-1 ${
