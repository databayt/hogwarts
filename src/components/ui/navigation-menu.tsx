...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute start-0 top-full flex justify-center pt-2")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-center bg-muted text-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-xl shadow-lg md:w-[var(--radix-navigation-menu-viewport-width)]",
        className
      )}
      ref={ref}
      {...props}
