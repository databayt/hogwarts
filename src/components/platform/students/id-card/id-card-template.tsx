...
export const IDCardTemplateComponent = forwardRef<HTMLDivElement, IDCardTemplateProps>(
      ...
      return (
        <div ref={ref} style={cardStyle} className="id-card-front">
          ...
          <div style={{ display: "flex", gap: "3mm", alignItems: "flex-start" }}>
            <Avatar style={{ width: "20mm", height: "25mm", borderRadius: "2mm" }}>
              <AvatarImage
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: "9px", color: "#444", lineHeight: 1.4 }}>
                <p style={{ margin: "1mm 0" }}>
                  <strong>Class:</strong> {data.class} {data.section && `- ${data.section}`}
                </p>
                <p style={{ margin: "1mm 0" }}>
                  <strong>DOB:</strong> {format(new Date(data.dateOfBirth), "dd/MM/yyyy")}
                </p>
                {data.bloodGroup && (
                  <p style={{ margin: "1mm 0" }}>
      ...
      return (
        <div ref={ref} style={cardStyle} className="id-card-back">
          ...
          >
            ...
            {data.schoolPhone && <p style={{ margin: "1mm 0" }}>Tel: {data.schoolPhone}</p>}
            {data.schoolWebsite && (
