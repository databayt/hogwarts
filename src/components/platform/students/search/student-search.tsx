...
const statusOptions = [
  ...
  { value: "DROPPED_OUT", label: "Dropped Out", color: "bg-red-100 text-red-800" },
];
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              setFilters(prev => ({
                                ...prev,
                                status: [...(prev.status || []), option.value as any],
                              }));
                            } else {
                              setFilters(prev => ({
                                ...prev,
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              setFilters(prev => ({
                                ...prev,
                                type: [...(prev.type || []), option.value as any],
                              }));
                            } else {
                              setFilters(prev => ({
                                ...prev,
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              ...
                              setFilters(prev => ({
                                ...prev,
                                gender: prev.gender?.filter(g => g !== option.value),
                              }));
                            }
                          }}
                        />
          ...
          {activeFilterCount > 0 && (
            <div className="flex items-center gap-2">
              <Badge variant="secondary">
                {activeFilterCount} {activeFilterCount === 1 ? "ListFilter" : "Filters"} Applied
              </Badge>
              <Button
                variant="ghost"
                size="sm"
