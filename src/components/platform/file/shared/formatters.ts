 ...
 */
export function formatDuration(seconds: number, locale: "en" | "ar" = "en"): string {
 ...
 */
export function getCategoryDisplayName(category: FileCategory, locale: "en" | "ar" = "en"): string {
 ...
 */
export function getTypeDisplayName(type: FileType, locale: "en" | "ar" = "en"): string {
