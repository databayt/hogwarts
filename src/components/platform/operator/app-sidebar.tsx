...
import { IconDashboard, IconListDetails, IconFolder, IconUsers, IconBuildingSkyscraper } from "@tabler/icons-react";

import { NavMain } from "@/components/platform/operator/nav-main";
import { NavUser } from "@/components/platform/operator/nav-user";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
