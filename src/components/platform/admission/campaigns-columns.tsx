  ...
  return [
    {
      accessorKey: "name",
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t?.campaigns?.campaignName || "Name"} />
      ),
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t?.campaigns?.academicYear || "Year"} />
      ),
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t?.nav?.applications || "Applications"} />
      ),
      cell: ({ getValue }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t?.campaigns?.totalSeats || "Seats"} />
      ),
      cell: ({ getValue }) => (
        <span className="text-sm tabular-nums">{getValue<number>()}</span>
      ),
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t?.campaigns?.startDate || "Start"} />
      ),
      cell: ({ getValue }) => (
    ...
    },
    {
      accessorKey: "endDate",
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t?.campaigns?.endDate || "End"} />
      ),
      cell: ({ getValue }) => (
        <span className="text-xs tabular-nums text-muted-foreground">
          {new Date(getValue<string>()).toLocaleDateString()}
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem>{t?.campaigns?.editCampaign || "Edit"}</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        );
      },
