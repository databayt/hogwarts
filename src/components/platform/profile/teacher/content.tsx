...
const generateMockTeacherProfile = (): TeacherProfile => ({
  ...
  coverImage: 'https://images.unsplash.com/photo-1580894742597-87bc8789db3d?w=1200&h=400&fit=crop',
    ...
    experience: [
      {
        ...
        responsibilities: 'Teaching undergraduate courses, research supervision',
        createdAt: new Date(),
        updatedAt: new Date()
      }
    ],
  ...
  professionalInfo: {
    ...
    joiningDate: new Date('2018-08-15'),
    totalExperience: 10,
    specializations: ['Machine Learning', 'Data Structures', 'Algorithms', 'Web Development'],
    researchInterests: ['AI in Education', 'Adaptive Learning Systems', 'Computer Vision'],
...
export function TeacherProfileContent({
  ...
  const tabs: TabConfig[] = [
    ...
    { id: 'classes', label: 'Classes', icon: <Users className="h-4 w-4" />, badge: 12 },
    ...
    { id: 'publications', label: 'Publications', icon: <BookOpen className="h-4 w-4" />, badge: 5 },
    { id: 'reviews', label: 'Reviews', icon: <Star className="h-4 w-4" />, badge: 234 }
  ]
