...
export function generateAttendanceExcel({
  ...
  const headers = isArabic
    ? ["التاريخ", "الطالب", "الفصل", "الحالة", "الطريقة", "وقت الدخول", "وقت الخروج", "ملاحظات"]
    : ["Date", "Student", "Class", "Status", "Method", "Check-in", "Check-out", "Notes"];
  ...
  const analyticsData = [
    ...
    [],
    [isArabic ? "الحالة" : "Status", isArabic ? "العدد" : "Count", isArabic ? "النسبة" : "Percentage"],
