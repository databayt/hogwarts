...
export function LessonFormFooter({ currentStep, isView, currentId, onBack, onNext, onSaveCurrentStep, form }: FooterProps) {
          ...
          {!isView && (
            <>
              ...
              <Button 
                ...
                onClick={onNext}
              >
                {currentStep === 3 ? (currentId ? 'Save' : 'Create') : 'Next'}
              </Button>
            </>
          )}
        </div>
