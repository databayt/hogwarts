...
export const pdfTemplateCustomizationSchema = z.object({
  headerColor: z.string().regex(/^#[0-9A-F]{6}$/i, "Invalid hex color").default("#3B82F6"),
...
export type PDFTemplateCustomization = z.infer<typeof pdfTemplateCustomizationSchema>;
