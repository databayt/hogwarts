...
>(
  ...
  if (
    val.passingMarks !== undefined &&
    val.totalMarks !== undefined &&
    val.passingMarks > val.totalMarks
  ) {
    ctx.addIssue({
      code: z.ZodIssueCode.custom,
...
export const examCreateSchema = examBaseObjectSchema
  .merge(
    z.object({
...
export const examUpdateSchema = examBaseObjectSchema
  .partial()
  .merge(
    z.object({
