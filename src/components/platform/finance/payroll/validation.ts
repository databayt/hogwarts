...
export const payrollRunSchema = z.object({
  ...
  status: z.enum(['DRAFT', 'PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED']).default('DRAFT'),
  ...
  (data) => data.paymentDate >= data.periodEnd,
  {
...
export const salarySlipSchema = z.object({
  ...
  paymentMethod: z.enum(['BANK_TRANSFER', 'CASH', 'CHECK', 'MOBILE_MONEY']).optional(),
