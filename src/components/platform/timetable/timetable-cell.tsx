...
const SUBJECT_COLORS: Record<string, string> = {
  ...
  Reading: "bg-indigo-100 border-indigo-300 dark:bg-indigo-900/50 dark:border-indigo-800",
  Korean: "bg-violet-100 border-violet-300 dark:bg-violet-900/50 dark:border-violet-800",
  Chinese: "bg-red-100 border-red-300 dark:bg-red-900/50 dark:border-red-800",
  Sports: "bg-teal-100 border-teal-300 dark:bg-teal-900/50 dark:border-teal-800",
...
function TimetableCellComponent({
  ...
  if (isEmpty) {
    return (
      <div
        className={cn(
          "py-5 px-8 flex items-center justify-center transition-all duration-200",
          "bg-muted/20",
          !isLastColumn && "border-r border-border",
          onSubjectChange && "cursor-pointer hover:bg-muted/40",
          "print:py-4"
        )}
  ...
  return (
    <>
      <div
        ...
        onDoubleClick={handleDoubleClick}
        title={onSubjectChange ? "Double-click to edit subject" : "Click for teacher info"}
      >
        <TeacherInfoPopup
          subject={subject}
        ...
        >
          <div className="w-full flex flex-col items-center justify-center">
            <span
              className={cn(
                "font-medium text-center print:text-base print:font-semibold",
