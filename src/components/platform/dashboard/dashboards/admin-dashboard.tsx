...
export async function AdminDashboard({ user, dictionary, locale = "en" }: Props) {
  ...
  const dashboardProps = {
    ...
    financeStats: [
      ...
      { label: "Collected", value: `$${((financialData.totalRevenue * financialData.collectionRate) / 100000).toFixed(0)}K` },
      { label: "Pending", value: `$${((financialData.totalRevenue * (100 - financialData.collectionRate)) / 200000).toFixed(0)}K` },
      { label: "Overdue", value: `$${((financialData.totalRevenue * (100 - financialData.collectionRate)) / 400000).toFixed(0)}K` },
    ],
    ...
    todaySummary: [
      ...
      { label: "Fees Collected", value: `$${((financialData.totalRevenue * financialData.collectionRate) / 100000).toFixed(0)}K` },
