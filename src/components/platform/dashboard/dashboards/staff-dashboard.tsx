...
import { StaffDashboardStats } from "@/components/platform/shared/stats"
...
export async function StaffDashboard({
  ...
  const mockVisitorLog = [
    {
      visitor: "Parent - Mrs. Johnson",
      purpose: "Parent meeting",
      time: "9:00 AM",
      status: "checked-in",
    },
    {
      visitor: "Vendor - Office Supplies",
      purpose: "Delivery",
      time: "10:30 AM",
      status: "checked-out",
    },
  ...
  return (
    <div className="space-y-6">
      {/* Hero Section - Using new reusable component */}
      <StaffDashboardStats
        todaysTasks={mockTodayTasks.length}
        pendingRequests={mockPendingRequests.length}
        systemAlerts={mockSystemAlerts.length}
        totalTasks={mockWorkflowStatus.totalTasks}
      />
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="text-center">
              <p className="text-2xl font-bold text-primary">{mockWorkflowStatus.inQueue}</p>
            ...
            <div className="text-center">
              <p className="text-2xl font-bold text-destructive">{mockWorkflowStatus.overdue}</p>
          ...
          <div className="mt-4">
            <Progress
              value={
                ((mockWorkflowStatus.completedToday + mockWorkflowStatus.inQueue) /
