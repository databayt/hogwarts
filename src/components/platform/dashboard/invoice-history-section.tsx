  ...
  GUARDIAN: [
    {
      ...
      amount: "5,000 SAR",
      status: "paid",
      description: "Ahmed - Term 1 Tuition",
    },
    {
      id: "chi_002",
      date: "Dec 1, 2024",
      amount: "4,800 SAR",
      status: "open",
      description: "Sara - Term 1 Tuition",
    },
    {
      id: "chi_003",
      date: "Nov 15, 2024",
  ...
  ACCOUNTANT: [
    {
      ...
      amount: "125,000 SAR",
      status: "paid",
      description: "November Collection",
    },
    {
      id: "inv_002",
      date: "Dec 10, 2024",
    ...
    },
    {
      ...
      amount: "8,500 SAR",
      status: "paid",
      description: "Staff Reimbursements",
    },
    {
      id: "inv_004",
      date: "Nov 30, 2024",
  ...
  PRINCIPAL: [
    {
      ...
      amount: "250,000 SAR",
      status: "paid",
      description: "Q4 Operating Budget",
    },
    {
      id: "bud_002",
      date: "Nov 15, 2024",
  ...
  DEVELOPER: [
    {
      ...
      amount: "$2,499.00",
      status: "paid",
      description: "Enterprise - School A",
    },
    {
      id: "dev_002",
      date: "Dec 1, 2024",
...
export function StaticInvoiceHistorySection({
  ...
  const data =
    invoices || defaultInvoicesByRole[role] || defaultInvoicesByRole.ADMIN
  const title = sectionTitle || getHistoryTitleByRole(role)
