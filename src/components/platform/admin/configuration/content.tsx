...
import { School, Calendar, Building, Palette, Users, CheckCircle2, AlertCircle } from "lucide-react"
...
export default async function ConfigurationContent({ dictionary, lang }: Props) {
  ...
  const setupSteps = [
    ...
    { name: 'Branding', completed: !!branding?.primaryColor },
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Two Column Layout for Capacity and Branding */}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>Students, teachers, and facilities</CardDescription>
                </div>
              </div>
            </div>
          </CardHeader>
