...
import type { CertStepDefinition } from "../types"

interface CertWizardShellProps {
  steps: CertStepDefinition[]
  lang: string
  children: React.ReactNode
}

export function CertWizardShell({
  steps,
  lang,
  children,
}: CertWizardShellProps) {
      ...
      <div className="border-b px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push(`/${lang}/exams/certificates`)}
