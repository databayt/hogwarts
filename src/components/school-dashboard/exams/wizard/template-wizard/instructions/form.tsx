...
import { updateTemplateInstructions } from "./actions"

const SLOT: SlotName = "instructions"
...
export const InstructionsForm = forwardRef<
  WizardFormRef,
    ...
    saveAndNext: () =>
      new Promise<void>((resolve, reject) => {
        startTransition(async () => {
          try {
            const result = await updateTemplateInstructions(
              templateId,
              selected
            )
            if (!result.success) {
