...
| `paper/config-form.tsx:56-68,881`                                                  | `labelAr` for curriculum presets                      | use `getDisplayText()` or dictionary |
...
- `prisma/models/exam.prisma`, `school-exam.prisma`, `school-qbank.prisma`, `question.prisma`, `quiz.prisma`, `grading-scheme.prisma`
