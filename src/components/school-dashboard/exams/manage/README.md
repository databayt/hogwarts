...
```typescript
import { updateExam } from "@/components/school-dashboard/exams/manage/actions"
...
```typescript
import { getExams } from "@/components/school-dashboard/exams/manage/actions"
...
```typescript
import { enterMarks } from "@/components/school-dashboard/exams/manage/actions"
...
```typescript
import { getExamAnalytics } from "@/components/school-dashboard/exams/manage/actions"
