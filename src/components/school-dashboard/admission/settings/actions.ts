...
export async function saveAdmissionSettings(
  ...
  try {
    ...
    const settingsData = {
      ...
      enablePublicPortal: validated.data.enablePublicPortal,
      enableInquiryForm: validated.data.enableInquiryForm,
      enableTourBooking: validated.data.enableTourBooking,
      enableStatusTracker: validated.data.enableStatusTracker,
