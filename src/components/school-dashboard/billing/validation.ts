...
export const invoiceFilterSchema = z
  ...
  .refine(
    (data) =>
      !data.amountMax || !data.amountMin || data.amountMax >= data.amountMin,
    {
...
export const billingHistoryFilterSchema = z
  .object({
...
export type UpdateBillingPreferencesInput = z.infer<
  typeof updateBillingPreferencesSchema
>
export type InvoiceFilterInput = z.infer<typeof invoiceFilterSchema>
export type BillingHistoryFilterInput = z.infer<
  typeof billingHistoryFilterSchema
>
export type CreateBillingHistoryInput = z.infer<
