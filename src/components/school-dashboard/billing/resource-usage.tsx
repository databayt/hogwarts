...
import { Book, Database, GraduationCap, Users } from "lucide-react"
...
import { getUsageSeverity, USAGE_THRESHOLDS } from "./config"
          ...
          {[
            {
              name: "Students",
              icon: Users,
              current: stats.currentUsage.students,
            ...
            },
            {
              name: "Teachers",
              icon: GraduationCap,
              current: stats.currentUsage.teachers,
            ...
            },
            {
              name: "Classes",
              icon: Book,
              current: stats.currentUsage.classes,
            ...
            },
            {
              name: "Storage",
              icon: Database,
              current: stats.currentUsage.storage,
