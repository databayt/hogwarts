...
const styles = StyleSheet.create({
  ...
  prefix: { textAlign: "center", marginBottom: 6 },
  frame: {
    borderWidth: 2,
    paddingVertical: 8,
...
export function FramedRecipient({ data, theme }: CertRecipientProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.frame, { borderColor: theme.colors.gold }]}>
        <Text
          style={[
            styles.name,
            {
