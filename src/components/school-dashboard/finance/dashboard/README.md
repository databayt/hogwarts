...
```tsx
// In your page.tsx
import { FinanceDashboardContent } from "@/components/school-dashboard/finance/lab/content"
...
```bash
# Run tests
pnpm test src/components/school-dashboard/finance/lab

# Test specific component
pnpm test src/components/school-dashboard/finance/lab/kpi-card.test.tsx
```
