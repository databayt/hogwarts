...
import type { BankAccount, BankingDictionary, Transaction } from "../types"
...
function TransactionsTableImprovedInner({
  ...
  return (
    <Card className={className}>
        ...
        <div className="flex flex-col gap-4 lg:flex-row">
          <div className="relative flex-1">
            ...
            <Input
              type="search"
              placeholder={
                dictionary?.searchTransactions || "Search transactions..."
              }
            ...
            <TableHeader>
              <TableRow>
                <TableHead className="w-[50px]">
                  <Checkbox
                    checked={
                      selectedRows.size === paginatedTransactions.length &&
                ...
                {visibleColumns.date && (
                  <TableHead>
                    <Button
                      variant="ghost"
                      className="hover:text-foreground h-auto p-0 font-medium"
                  ...
                  >
                    ...
                    {visibleColumns.status && (
                      <TableCell>
                        <Badge
                          variant={
                            transaction.pending ? "secondary" : "default"
                          }
      ...
      <Sheet
        open={!!detailsSheet}
        onOpenChange={(open) => !open && setDetailsSheet(null)}
      >
        <SheetContent>
          <SheetHeader>
