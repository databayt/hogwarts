...
// ---------------------------------------------------------------------------
// Constants (merged from the former constants.ts). They live here, not in
 ...
 * nothing is ever written to the database for it.
 */
export const DRAFT_TERM_ID = "__draft__"

/** Working day presets for quick configuration. */
export const WORKING_DAY_PRESETS = {
  "sun-thu": { label: "أحد–خميس", days: [0, 1, 2, 3, 4] },
  "mon-fri": { label: "اثنين–جمعة", days: [1, 2, 3, 4, 5] },
  "mon-sat": { label: "اثنين–سبت", days: [1, 2, 3, 4, 5, 6] },
  custom: { label: "مخصص", days: [] },
} as const
