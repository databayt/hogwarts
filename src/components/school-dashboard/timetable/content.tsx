...
import "./print.css"
import { TimetableHeader } from "@/components/school-dashboard/timetable/timetable-header"
import { TimetableGrid } from "@/components/school-dashboard/timetable/timetable-grid"
import { AboutHoverCard } from "@/components/school-dashboard/timetable/about-hover-card"
import { ConfigDialog } from "@/components/school-dashboard/timetable/config-dialog"
import { Skeleton } from "@/components/ui/skeleton"
import { useTimetableStore } from "@/components/school-dashboard/timetable/timetable"
import { getFallbackTimetableData } from "@/components/school-dashboard/timetable/fallback-data"
        ...
        <div className=" max-w-4xl mx-auto print:max-w-none">
          ...
          {error ? (
            <div className="overflow-x-auto rounded-xl border border-border">
              <pre className="p-4 bg-destructive/10 text-destructive overflow-auto">
                {error}
              </pre>
            </div>
