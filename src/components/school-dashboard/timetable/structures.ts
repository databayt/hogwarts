...
export const TIMETABLE_STRUCTURES: TimetableStructure[] = [
  {
    ...
    periods: [
      ...
      {
        // THE فسحة — the single mid-morning break, when فطور is eaten. A
        // Sudanese school day has exactly one; there is no second break and no
        // lunch (الغداء is eaten at home after dismissal).
        // Confirmed with Abdout, 2026-07-17.
        name: "Break",
        startTime: "09:55",
        endTime: "10:35",
        type: "break",
    ...
    lunchAfterPeriod: null, // no school lunch — الغداء is eaten at home after dismissal
    periodsPerDay: 8,
    schoolStart: "07:30",
    schoolEnd: "14:40",
    isDefault: true,
  ...
  },
  {
    ...
    periods: [
      ...
      {
        // THE single فسحة — see sd-gov-default. No second break, no lunch.
        name: "Break",
        startTime: "09:55",
        endTime: "10:35",
        type: "break",
  ...
  },
  {
    ...
    descriptionEn: "7 periods x 50min, Mon-Fri, standard US 6-12 schedule",
    lang: "en",
    country: "US",
  ...
  {
    slug: "eg-secondary",
    name: "الجدول المصري — الإعدادي والثانوي",
    nameEn: "Egypt Secondary / Preparatory",
    description: "٧ حصص × ٤٥ دقيقة، الأحد - الخميس",
    descriptionEn:
      "7 periods x 45min, Sun-Thu, Egyptian preparatory & secondary",
    lang: "ar",
    country: "EG",
    schoolType: ["public", "national"],
    schoolLevel: ["middle", "secondary", "both"],
  ...
  {
    slug: "kw-primary",
    name: "الجدول الكويتي — الابتدائي",
    nameEn: "Kuwait Primary",
    description: "٦ حصص × ٤٥ دقيقة، الأحد - الخميس",
    descriptionEn:
      "6 periods x 45min, Sun-Thu, Kuwaiti primary (30 periods/week)",
    lang: "ar",
    country: "KW",
    schoolType: ["public", "national"],
    schoolLevel: ["primary"],
  ...
  // --------------------------------------------------------------------------
  // Grade-specific structures (primary vs secondary)
  // --------------------------------------------------------------------------
  {
    slug: "sd-gov-primary",
    name: "الجدول الحكومي السوداني — الأساس",
    nameEn: "Sudan Government Primary",
    description: "٦ حصص × ٤٠ دقيقة، الأحد - الخميس",
    descriptionEn:
      "6 periods x 40min, Sun-Thu, Sudan basic education (grades 1-6)",
    lang: "ar",
    country: "SD",
    schoolType: ["public", "national"],
    schoolLevel: ["primary"],
  ...
  {
    slug: "sa-primary",
    name: "الجدول السعودي — الابتدائي",
    nameEn: "Saudi Primary",
    description: "٧ حصص × ٤٥ دقيقة، الأحد - الخميس",
    descriptionEn:
      "7 periods x 45min, Sun-Thu, Saudi MOE primary (33 periods/week)",
    lang: "ar",
    country: "SA",
    schoolType: ["public", "private", "national"],
    schoolLevel: ["primary", "both"],
    workingDays: [0, 1, 2, 3, 4],
    periods: [
      {
        name: "Period 1",
  ...
  {
    slug: "sa-secondary",
    name: "الجدول السعودي — المتوسط والثانوي",
    nameEn: "Saudi Intermediate / Secondary",
    description: "٧ حصص × ٥٠ دقيقة، الأحد - الخميس",
    descriptionEn:
      "7 periods x 50min, Sun-Thu, Saudi MOE intermediate & secondary (35/32 periods/week)",
    lang: "ar",
    country: "SA",
    schoolType: ["public", "private", "national"],
  ...
  {
    slug: "eg-primary",
    name: "الجدول المصري — الابتدائي",
    nameEn: "Egypt Primary",
    description: "٦ حصص × ٤٠ دقيقة، الأحد - الخميس",
    descriptionEn:
      "6 periods x 40min, Sun-Thu, Egyptian primary (30 periods/week)",
    lang: "ar",
    country: "EG",
    schoolType: ["public", "national"],
    schoolLevel: ["primary"],
  ...
  {
    slug: "kw-secondary",
    name: "الجدول الكويتي — المتوسط والثانوي",
    nameEn: "Kuwait Intermediate / Secondary",
    description: "٧ حصص × ٤٥ دقيقة، الأحد - الخميس",
    descriptionEn:
      "7 periods x 45min, Sun-Thu, Kuwaiti intermediate & secondary (35 periods/week)",
    lang: "ar",
    country: "KW",
    schoolType: ["public", "national"],
    schoolLevel: ["middle", "secondary", "both"],
  ...
  {
    slug: "ae-primary",
    name: "جدول الإمارات — الحلقة الأولى",
    nameEn: "UAE Cycle 1 (Primary)",
    description: "٥ حصص × ٤٠ دقيقة، الاثنين - الجمعة",
    descriptionEn:
      "5 periods x 40min, Mon-Fri, UAE Cycle 1 grades 1-4 (23 periods/week)",
    lang: "ar",
    country: "AE",
    schoolType: ["public", "private", "national"],
    schoolLevel: ["primary"],
  ...
  {
    slug: "ae-secondary",
    name: "جدول الإمارات — الحلقة الثانية والثالثة",
    nameEn: "UAE Cycle 2-3 (Secondary)",
    description: "٦ حصص × ٤٠ دقيقة، الاثنين - الجمعة",
    descriptionEn:
      "6 periods x 40min, Mon-Fri, UAE Cycles 2-3 grades 5-12 (27-28 periods/week)",
    lang: "ar",
    country: "AE",
    schoolType: ["public", "private", "national"],
    schoolLevel: ["middle", "secondary", "both"],
  ...
  {
    slug: "jo-primary",
    name: "الجدول الأردني — الأساسي الأدنى",
    nameEn: "Jordan Lower Basic",
    description: "٦ حصص × ٤٥ دقيقة، الأحد - الخميس",
    descriptionEn:
      "6 periods x 45min, Sun-Thu, Jordan lower basic grades 1-6 (30 periods/week)",
    lang: "ar",
    country: "JO",
    schoolType: ["public", "private", "national"],
    schoolLevel: ["primary"],
  ...
  {
    slug: "jo-secondary",
    name: "الجدول الأردني — الأساسي الأعلى والثانوي",
    nameEn: "Jordan Upper Basic / Secondary",
    description: "٧ حصص × ٤٥ دقيقة، الأحد - الخميس",
    descriptionEn:
      "7 periods x 45min, Sun-Thu, Jordan upper basic & secondary grades 7-12 (35 periods/week)",
    lang: "ar",
    country: "JO",
    schoolType: ["public", "private", "national"],
    schoolLevel: ["middle", "secondary", "both"],
  ...
  {
    slug: "qa-national",
    name: "الجدول القطري الحكومي",
    nameEn: "Qatar National",
    description: "٧ حصص × ٤٥ دقيقة، الأحد - الخميس",
    descriptionEn:
      "7 periods x 45min, Sun-Thu (6 on Wed-Thu), Qatar MOE (34-35 periods/week)",
    lang: "ar",
    country: "QA",
    schoolType: ["public", "private", "national"],
    schoolLevel: ["primary", "middle", "secondary", "both"],
  ...
  },
  {
    slug: "us-elementary",
    name: "US Elementary",
    nameEn: "US Elementary",
    description: "6 periods x 45min, Mon-Fri",
    descriptionEn: "6 periods x 45min, Mon-Fri, US elementary K-5 schedule",
    lang: "en",
    country: "US",
    schoolType: ["public", "private", "charter"],
    schoolLevel: ["primary"],
