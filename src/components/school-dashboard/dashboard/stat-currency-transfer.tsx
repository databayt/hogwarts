                  ...
                  {!isCompleted ? (
                    ...
                    >
                      <div className="relative z-10">
                        ...
                        />
                        <div className="bg-card relative z-10 rounded-full p-5 shadow-[0_0_15px_rgba(16,185,129,0.1)]">
                    ...
                    <motion.div
                      ...
                      className="flex h-[100px] w-[100px] items-center justify-center"
                    >
                      <div className="bg-card relative z-10 rounded-full border border-emerald-500 p-5">
                        <Check
            ...
            >
              <AnimatePresence mode="wait">
                {isCompleted ? (
                  <motion.h2
                    key="completed-title"
                    className="text-foreground text-lg font-semibold tracking-tighter uppercase"
              ...
              <div className="mt-4 flex items-center gap-4">
                ...
                >
                  ...
                  >
                    <motion.div
                      className={cn(
                        "bg-muted/50 w-full rounded-xl border p-2.5 backdrop-blur-md transition-all duration-300",
                        isCompleted
                      ...
                      <div className="w-full space-y-1">
                        ...
                        <div className="flex flex-col gap-1.5">
                          <div className="group flex items-center gap-2.5">
                            <span className="bg-card inline-flex h-7 w-7 items-center justify-center rounded-lg border text-sm font-medium shadow-lg">
                              $
                            </span>
              ...
              <motion.div
                className="text-muted-foreground mt-2 flex items-center justify-center gap-2 text-xs"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{
                  delay: 0.5,
