...
/**
 * Detect whether a string contains Arabic script characters.
 * Used to check if text was not translated and should be hidden or replaced.
 */
...
/**
 * Detect whether a string contains Latin script characters.
 */
