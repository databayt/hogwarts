...
> {
  ...
  // The in-app SFU room is LiveKit-only. External sessions are joined directly
  // via their meeting URL (handled in the UI), never through a token here.
  if (liveClass.provider === "external" || !liveClass.roomName) {
