  ...
  const filteredParents = useMemo(() => {
    return mockParents.filter((parent) => {
      ...
      const matchesEngagement =
        ...
        parent.engagementLevel === engagementFilter
      const matchesPayment =
        paymentFilter === "all" || parent.paymentStatus === paymentFilter
      ...
      {viewMode === "grid" ? (
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {filteredParents.map((parent) => (
            <Card key={parent.id} className="transition-shadow hover:shadow-lg">
              <CardContent className="p-6">
                ...
                <div className="mb-4">
                  <div className="mb-2 flex items-center gap-2">
                    <Baby className="text-muted-foreground h-3 w-3" />
                ...
                <div className="mb-4 grid grid-cols-2 gap-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      className={cn(
                        getEngagementColor(parent.engagementLevel),
                        "text-xs"
                      )}
                    >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      className={cn(
                        getPaymentColor(parent.paymentStatus),
        ...
        <Card>
          <CardContent className="p-0">
            <table className="w-full">
              ...
              <tbody>
                {filteredParents.map((parent) => (
                  <tr key={parent.id} className="hover:bg-accent/50 border-b">
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                    ...
                    <td className="hidden p-4 xl:table-cell">
                      <span className="text-sm">
                        {format(parent.lastContact, "MMM dd, yyyy")}
                      </span>
                    </td>
                    <td className="p-4">
