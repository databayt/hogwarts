            ...
            <CardContent>
              <div className="grid grid-cols-7 gap-2">
                {weekDays.map((day, index) => {
                  ...
                  const dayMeetings = mockMeetings.filter((m) =>
                    isSameDay(m.date, day)
                  )
                  ...
                  return (
                    <div
                      key={day.toISOString()}
                      className={cn(
                        "hover:bg-muted/50 min-h-[120px] cursor-pointer rounded-lg border p-3 transition-colors",
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                {weekSchedule[format(selectedDate, "EEEE")]?.map(
                  (slot, index) => (
                    <div
                      key={index}
                      className={cn(
          ...
          <CardContent>
            ...
            <div className="mb-4 grid grid-cols-2 gap-3">
              <div className="bg-muted/50 rounded-lg p-3">
                <p className="text-muted-foreground text-xs">Annual Leave</p>
                <p className="text-lg font-bold">12 days</p>
                <p className="text-muted-foreground text-xs">Available</p>
              </div>
              <div className="bg-muted/50 rounded-lg p-3">
                <p className="text-muted-foreground text-xs">Sick Leave</p>
