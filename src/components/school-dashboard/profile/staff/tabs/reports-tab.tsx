...
const mockTemplates: ReportTemplate[] = [
  {
    ...
    description:
      "Comprehensive financial overview including revenue, expenses, and budget variance",
    type: "financial",
    frequency: "monthly",
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {profile.workMetrics?.reportsGenerated || 48}
            </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-1">
                      ...
                      <div className="text-muted-foreground flex items-center gap-4 text-sm">
                        ...
                        {template.lastRun && (
                          <span>
                            Last run: {format(template.lastRun, "MMM dd, yyyy")}
                          </span>
                        )}
                        {template.nextRun && (
                          <span>
                            Next run: {format(template.nextRun, "MMM dd, yyyy")}
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-2">
                      ...
                      <div className="text-muted-foreground flex items-center gap-4 text-sm">
                        ...
                        <span>
                          Next: {format(schedule.nextRun, "MMM dd, h:mm a")}
                        </span>
                        {schedule.lastRun && (
                          <span>
                            Last: {format(schedule.lastRun, "MMM dd, h:mm a")}
                          </span>
                        )}
                      </div>
                      <div className="flex items-center gap-2">
