...
const mockDepartmentGoals: DepartmentGoal[] = [
  {
    ...
    description:
      "Improve budget forecasting accuracy and reduce variance between projected and actual expenses",
    progress: 75,
  ...
  },
  {
    ...
    description:
      "Complete transition from paper-based to digital financial record keeping system",
    progress: 60,
  ...
  },
  {
    ...
    description:
      "Deploy and train staff on new automated payroll processing system",
    progress: 40,
...
const mockProjects: Project[] = [
  {
    ...
    description:
      "Upgrading the school financial management system to cloud-based solution",
...
export function ResponsibilitiesTab({
  ...
  const [selectedView, setSelectedView] = useState<
    "primary" | "committees" | "projects" | "processes"
  >("primary")
      ...
      >
        ...
        <TabsContent value="primary" className="space-y-4">
          ...
          {responsibilities.secondary &&
            responsibilities.secondary.length > 0 && (
              <Card>
                <CardHeader>
                ...
                <CardContent className="space-y-3">
                  {responsibilities.secondary.map(
                ...
                <div key={goal.id} className="rounded-lg border p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-muted-foreground flex items-center justify-between text-xs">
                      <span>
                        {goal.completedTasks}/{goal.assignedTasks} tasks
                        completed
                      </span>
              ...
              {mockCommittees.map((committee: any) => (
                <div key={committee.id} className="rounded-lg border p-4">
                  ...
                  {committee.nextMeeting && (
                    <div className="bg-muted/50 mb-3 flex items-center gap-2 rounded p-2">
                      <Calendar className="h-3 w-3" />
                      <span className="text-xs">
                        Next meeting:{" "}
                        {format(committee.nextMeeting, "MMM dd, yyyy")}
                      </span>
                    </div>
                  )}
              ...
              {mockProjects.map((project: any) => (
                <div key={project.id} className="rounded-lg border p-4">
                  ...
                  <div className="text-muted-foreground flex items-center justify-between text-xs">
                    ...
                    {project.endDate && (
                      <span>
                        End: {format(project.endDate, "MMM dd, yyyy")}
                      </span>
                    )}
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      <div
                        className={cn(
                          ...
                          process.category === "administrative" &&
                            "text-blue-500",
                          process.category === "operational" &&
                            "text-purple-500",
