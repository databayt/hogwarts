...
export function AchievementsTab({
  ...
  const categories = Array.from(
    new Set(mockAchievements.map((a) => a.category))
  )
        ...
        <Card>
          <CardContent className="p-4">
            <div className="mb-2 flex items-center gap-2">
              ...
              <p className="text-muted-foreground text-sm">Skill Badges</p>
            </div>
            ...
            {mockSkillBadges.map((badge) => (
              <Card key={badge.id}>
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div
                      className={cn("rounded-lg p-3 text-white", badge.color)}
                    >
                      {badge.icon}
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        <div className="flex gap-0.5">
                          {Array.from({ length: badge.maxLevel }).map(
                            (_, i) => (
                              <div
                                key={i}
                                className={cn(
