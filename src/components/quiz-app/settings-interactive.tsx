...
import { categoryOptions, difficultyOptions } from "./config";
...
export default function SettingsInteractive(props: Props) {
  ...
  const handleQuizStart = () => {
    router.push(
      `/${props.lang}/quiz-app/questions?category=${category}&difficulty=${difficulty}&limit=${limit[0]}`
    );
  };
