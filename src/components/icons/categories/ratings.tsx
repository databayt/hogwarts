 ...
 * Rating Icons
 *
 * Icons for visual ratings like excellent, good, average, poor.
 * Used in pricing comparisons and feature quality indicators.
 * Migrated from src/components/atom/icons.tsx
 */

import type { IconProps } from "../types"

export const ExcellentIcon = (props: IconProps) => (
...
export const GoodIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <path
      fill="currentColor"
...
export const PoorIcon = (props: IconProps) => (
