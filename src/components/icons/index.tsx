...
export const Icons = {
  ...
  alertCircle: SystemIcons.AlertCircleIcon,
  refresh: SystemIcons.RefreshCwIcon,
  moon: SystemIcons.MoonIcon,
  sun: SystemIcons.SunIcon,
  calendar: SystemIcons.CalendarIcon,
  search: SystemIcons.SearchIcon,
  fileText: SystemIcons.FileTextIcon,
  upload: SystemIcons.UploadIcon,
  download: SystemIcons.DownloadIcon,
  arrowLeft: SystemIcons.ArrowLeftIcon,
  arrowRight: SystemIcons.ArrowRightIcon,
  chevronDown: SystemIcons.ChevronDownIcon,
  chevronUp: SystemIcons.ChevronUpIcon,
  chevronLeft: SystemIcons.ChevronLeftIcon,
  chevronRight: SystemIcons.ChevronRightIcon,
  check: SystemIcons.CheckIcon,
  x: SystemIcons.XIcon,
  plus: SystemIcons.PlusIcon,
  minus: SystemIcons.MinusIcon,
  spinner: SystemIcons.Loader2Icon,
  moreHorizontal: SystemIcons.MoreHorizontalIcon,
  moreVertical: SystemIcons.MoreVerticalIcon,
  settings: SystemIcons.SettingsIcon,
  user: SystemIcons.UserIcon,
  users: SystemIcons.UsersIcon,
  mail: SystemIcons.MailIcon,
  eye: SystemIcons.EyeIcon,
  eyeOff: SystemIcons.EyeOffIcon,
  lock: SystemIcons.LockIcon,
  edit: SystemIcons.EditIcon,
  copy: SystemIcons.CopyIcon,
