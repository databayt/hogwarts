...
const ANTHROPIC_ASSETS: AnthropicIcon[] = [
  ...
  { name: "nodes", file: "agent-skills.svg", tags: ["agent", "skills", "radial"], category: "Anthropic" },
  { name: "clover", file: "advanced-tool-use.svg", tags: ["tools", "quad", "octagons"], category: "Anthropic" },
  { name: "blocks", file: "build-with-claude.svg", tags: ["build", "tetris", "outline"], category: "Anthropic" },
  { name: "rings", file: "building-effective-agents.svg", tags: ["circles", "grid", "agents"], category: "Anthropic" },
  { name: "diamond", file: "claude-agent-sdk.svg", tags: ["sdk", "square", "rotated"], category: "Anthropic" },
  { name: "layers", file: "claude-code-best-practices.svg", tags: ["code", "stack", "guide"], category: "Anthropic" },
  { name: "sandbox", file: "claude-code-sandboxing.svg", tags: ["box", "security", "isolation"], category: "Anthropic" },
  { name: "execute", file: "code-execution-mcp.svg", tags: ["mcp", "run", "code"], category: "Anthropic" },
  { name: "rays", file: "context-engineering.svg", tags: ["burst", "palm", "radial"], category: "Anthropic" },
  { name: "retrieve", file: "contextual-retrieval.svg", tags: ["rag", "fetch", "context"], category: "Anthropic" },
  { name: "desktop", file: "desktop-extensions.svg", tags: ["screen", "apps", "extensions"], category: "Anthropic" },
  { name: "async", file: "long-running-agents.svg", tags: ["agents", "loop", "background"], category: "Anthropic" },
  { name: "bench", file: "swe-bench.svg", tags: ["benchmark", "test", "coding"], category: "Anthropic" },
  { name: "arch", file: "think-tool.svg", tags: ["think", "bridge", "connect"], category: "Anthropic" },
  { name: "paper", file: "transparency.svg", tags: ["document", "text", "trust"], category: "Anthropic" },
  { name: "growth", file: "economic-futures.svg", tags: ["economics", "chart", "research"], category: "Anthropic" },
  { name: "diamond", file: "eng-agent-sdk.svg", tags: ["engineering", "sdk", "square"], category: "Anthropic" },
  { name: "nodes", file: "eng-agent-skills.svg", tags: ["engineering", "skills", "radial"], category: "Anthropic" },
  { name: "sandbox", file: "eng-claude-code-sandboxing.svg", tags: ["engineering", "box", "security"], category: "Anthropic" },
  { name: "execute", file: "eng-code-execution-mcp.svg", tags: ["engineering", "mcp", "run"], category: "Anthropic" },
  { name: "rays", file: "eng-context-engineering.svg", tags: ["engineering", "burst", "context"], category: "Anthropic" },
  { name: "desktop", file: "eng-desktop-extensions.svg", tags: ["engineering", "screen", "apps"], category: "Anthropic" },
  { name: "async", file: "eng-harnesses-long-running-agents.svg", tags: ["engineering", "loop", "agents"], category: "Anthropic" },
  { name: "hands", file: "Hands-Build.svg", tags: ["hand", "stack", "stones"], category: "Anthropic" },
  { name: "stack", file: "Hands-Stack.svg", tags: ["hand", "pile", "build"], category: "Anthropic" },
  { name: "puzzle", file: "Objects-Puzzle.svg", tags: ["pieces", "fit", "objects"], category: "Anthropic" },
  { name: "abstract", file: "6903d22d0099a66d72e05699_33ddc751e21fb4b116b3f57dd553f0bc55ea09d1-1000x1000.svg", tags: ["claude", "pattern", "art"], category: "Anthropic" },
  { name: "blocks", file: "category-01.svg", tags: ["tetris", "build", "outline"], category: "Anthropic" },
  { name: "spirals", file: "category-02.svg", tags: ["springs", "coils", "three"], category: "Anthropic" },
  { name: "chart", file: "category-03.svg", tags: ["graph", "axis", "wave"], category: "Anthropic" },
  { name: "weave", file: "category-04.svg", tags: ["pattern", "cross", "grid"], category: "Anthropic" },
  { name: "flow", file: "category-05.svg", tags: ["stream", "line", "path"], category: "Anthropic" },
  { name: "dots", file: "category-06.svg", tags: ["points", "scatter", "grid"], category: "Anthropic" },
  { name: "wave", file: "category-07.svg", tags: ["curve", "line", "flow"], category: "Anthropic" },
  { name: "mesh", file: "category-08.svg", tags: ["grid", "net", "cross"], category: "Anthropic" },
  { name: "orbit", file: "category-09.svg", tags: ["circle", "spin", "round"], category: "Anthropic" },
  { name: "branch", file: "category-10.svg", tags: ["tree", "split", "fork"], category: "Anthropic" },
  { name: "pulse", file: "category-11.svg", tags: ["beat", "signal", "wave"], category: "Anthropic" },
  { name: "grid", file: "category-12.svg", tags: ["squares", "matrix", "tiles"], category: "Anthropic" },
  { name: "spiral", file: "category-13.svg", tags: ["coil", "spin", "round"], category: "Anthropic" },
  { name: "lines", file: "category-14.svg", tags: ["strokes", "parallel", "bars"], category: "Anthropic" },
]
