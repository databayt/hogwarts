 ...
 *
 * Default theme configuration following tweakcn's flat structure.
 * Uses OKLCH color format for perceptual uniformity.
 */

import type { ThemeEditorState, ThemeStyleProps } from '@/types/theme-editor'

// Common styles that apply to both light and dark modes
...
export const DEFAULT_FONT_SANS = 'var(--font-geist-sans)'
export const DEFAULT_FONT_SERIF = 'var(--font-geist-mono)'
export const DEFAULT_FONT_MONO = 'var(--font-geist-mono)'

// Default light theme styles
export const defaultLightThemeStyles: Partial<ThemeStyleProps> = {
...
export const defaultDarkThemeStyles: Partial<ThemeStyleProps> = {
...
// Helper to get CSS variable name from property key
