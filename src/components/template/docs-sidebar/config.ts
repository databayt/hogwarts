  ...
  sidebarNav: [
    {
      ...
      items: [
        ...
        { title: "Entry Points", href: "/docs/entry-points", items: [] },
        { title: "Authentication", href: "/docs/authentication", items: [] },
        { title: "Onboarding", href: "/docs/onboarding", items: [] },
        { title: "Form", href: "/docs/form", items: [] },
        ...
        { title: "Rebound", href: "/docs/rebound", items: [] },
