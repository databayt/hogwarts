...
/**
 * Multi-Step Form Provider (Template)
 *
 ...
 *
 * **Role**: Core organism for managing multi-step form state
 *
 * **Usage Across App**:
 * - Onboarding flows (SaaS, newcomers)
 * - Application forms (admission, registration)
 * - Wizard forms (settings, configuration)
 * - Multi-page surveys
 * - Checkout flows
 *
 * @example
