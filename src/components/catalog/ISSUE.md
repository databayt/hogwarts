...
- [ ] **SD grade 12 — next focus (verified 2026-09-04 evening, `TEXTBOOK_AUDIT.md` → "Grade 12 verification")**: 20/20 books present and current (old curriculum; printed years 2005–2015, table in the ledger; nothing newer online). Owed: rebuild the 12 legacy pdftotext structures from the books' TOCs (basic maths 2/5, specialised Arabic 2/4, agriculture 2/27, commercial 2/39, engineering/geography/history 5/15 …), add the two staged arts-stream subjects (الفنون والتصميم rev. 2007, دراسات أدبية ولغوية) under `_incoming/2026-09-04/g12-gaps/`, then re-seed `sd` → `sd-content`. Not obtainable: التربية الإسلامية الخاصة, الدراسات الإسلامية (اختياري) — only ever on rowadaltamayoz.com (dead host).
