...
- [ ] **SD textbook update — deploy-gated remainder**: (a) `scripts/upload-textbooks-all.ts` + Neon branch + prod `db:seed:single sd` / `sd-content` — until then the CDN serves the OLD PDF/cover for every replaced slug and the 10 new subjects exist only locally; verify `sd-g10-arabic.cover` stays on the concept key (the scan has no cover). (b) **Re-author qbank/exams** for the 11 replaced subjects — their old-curriculum questions remain at subject scope, chapter-less (g8 geography 30, g10 chemistry 8, others 2–9). (c) **Decide the superseded rows** `sd-g10-literature` / `sd-g10-rhetoric` / `sd-g10-arabic-advanced` (still PUBLISHED; cascade on delete). (d) Still not online: g3 SMILE Starter 3, g6 SMILE Book 4, g8 التربية الفنية, new-curriculum g10 books for القرآن/الفرنسية/الأسرية/العسكرية/English/المسيحية, any new g11 book (2026/27 opened Sept 2026; aggregator "2026" g11 lists are the old taxonomy). (e) g5 duplicate dirs (home-economics≡clothing, technology≡ict) still undecided.
