...
- [ ] **SD grade 12 — deploy-gated remainder**: upload the 5 new subjects' assets (`--force --only=` the five new slugs; the 13 restructured subjects need no upload), prod `db:seed:single sd` then `sd-content`; re-author question banks for the 7 archived subjects (basic maths, specialised Arabic, computer science, geography, history, Islamic, physics); التربية الإسلامية الخاصة remains unobtainable (rowadaltamayoz.com host dead — the only site that ever carried it).
