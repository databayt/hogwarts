import { AnnouncementsContent } from '@/components/school/dashboard/announcements/content'
import { announcementsSearchParams } from '@/components/school/dashboard/announcements/list-params'
import { SearchParams } from 'nuqs/server'
import { db } from '@/lib/db'
import { getTenantContext } from '@/components/platform/operator/lib/tenant'
import { announcementColumns, type AnnouncementRow } from '@/components/school/dashboard/announcements/columns'
import { AnnouncementsTable } from '@/components/school/dashboard/announcements/table'
