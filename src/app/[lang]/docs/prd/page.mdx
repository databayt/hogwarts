...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-8">
  ...
  <div className="p-6 border rounded-lg">
    ...
    <p className="muted">Advanced capabilities like double-entry bookkeeping, comprehensive payroll, and AI-powered analytics typically reserved for expensive enterprise systems—offered at 1/10th the cost.</p>
  </div>
...
```typescript
// ❌ WRONG - No tenant scoping (security vulnerability)
...
Student enrollment • Comprehensive profile management (personal, academic, health, documents, achievements, disciplinary) • Search and filtering • Batch actions • Document upload • Health records tracking • Achievement tracking • Disciplinary records • Guardian links • Class enrollment • Status transitions • Attendance summary • Grade summary • Fee summary • Export (individual and bulk) • Previous education records • Emergency contact • Photo management • Batch management

### FR-041 to FR-060: Teacher & Staff Management
Teacher profile creation • Class assignments • Department assignment • Workload management • Attendance tracking and leave management • Qualifications management • Performance reviews • Subject expertise tracking • Teacher dashboard • Communication with guardians • Non-teaching staff management • ID card generation • Contract management • Emergency contact • Professional development tracking • Timetable view • Substitution management • Export and reports

### FR-061 to FR-080: Class & Subject Management
Subject creation • Class creation • Student enrollment in classes • Teacher assignment to classes • Class schedule configuration • Class capacity limits • Class analytics dashboard • Class announcements • Resource sharing • Gradebook access • Attendance sheet • Timetable view • Waitlist management • Class sections management • Class merging and splitting • Subject prerequisites • Subject categories and tags • Class archive • Class roster export

### FR-081 to FR-100: Attendance System
Daily attendance marking • Period-wise attendance • Attendance status types (Present, Absent, Late, Excused) • Attendance notes and reasons • Bulk attendance marking • Attendance correction • Student-level reporting • Class-level reporting • School-level reporting • Alerts and notifications • Excuse submission (guardian) • QR code check-in • Late arrival threshold • Early dismissal tracking • Make-up session tracking • Export • Calendar integration • Policy configuration

### FR-101 to FR-300: Additional Modules
> ⚠️ **Sections TBD - Coming Soon**
>
...
- **Color Contrast**: Text ≥ 4.5:1, large text (18pt+) ≥ 3:1, no information by color alone (use icons + text)
