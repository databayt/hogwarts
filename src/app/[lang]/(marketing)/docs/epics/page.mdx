...
> 📖 **For complete story details** with acceptance criteria, technical notes, and testing instructions, see the [full epics.md document](https://github.com/hogwarts/docs/blob/main/epics.md).
...
**Acceptance Criteria for Epic Completion:**
- ✅ NextAuth v5 configured with multiple providers
- ✅ 8 roles implemented with granular permissions
...
**Acceptance Criteria for Epic Completion:**
- ✅ School profile management working
- ✅ Academic year configuration with terms/periods
- ✅ Year level/grade setup
...
- ✅ Comprehensive student profiles (7 tabs)
- ✅ Search and filtering functional
- ✅ Batch operations working
- ✅ Document upload (birth certificates, medical records)
...
**Acceptance Criteria for Epic Completion:**
- ✅ Teacher profile creation working
...
Daily attendance marking • Period-wise tracking • QR code check-in • Alerts and notifications • Reporting at student, class, and school levels

### Epic 8: Assessment & Grading (22 stories)
Assignment creation • Submission portal • Grading interface • Gradebook • Report card generation • Score range configuration

### Epic 9: Fee Management (18 stories)
Fee structure setup • Payment recording • Invoice generation • Outstanding fees tracking • Scholarship management • Payment reminders

### Epic 10: Communication (12 stories)
Announcement system • Email notifications • Parent portal • Read tracking • Class-specific announcements • Emergency broadcasts

### Epic 11: Reporting & Analytics (14 stories)
Student reports • Class analytics • Attendance dashboards • Fee collection reports • Export functionality • Custom dashboards

### Epic 12: Polish & Launch (10 stories)
Performance optimization • Security hardening • Documentation completion • User onboarding • Training materials • Launch preparation
...
Epic 1 (Foundation)
  ↓
Epic 2 (Authentication) ─┬─→ Epic 3 (School Config)
                         │         ↓
                         ├─→ Epic 4 (Students) ─┬─→ Epic 6 (Classes) → Epic 7 (Attendance)
                         │         ↓             │         ↓
                         ├─→ Epic 5 (Teachers) ─┘    Epic 8 (Assessment)
                         │         ↓
                         ├─→ Epic 9 (Fees)
                         │         ↓
...
**Critical Path:** Epic 1 → Epic 2 → Epic 3 → Epic 4/5 → Epic 6 → Epic 7/8/9/10 → Epic 11 → Epic 12
...
- Epic 1 (Foundation): 8 points/story → 120 points total
- Epic 2 (Authentication): 5 points/story → 90 points total
- Epic 3-6: 3-5 points/story → 60-90 points each
- Epic 7-10: 3-5 points/story → 48-90 points each
- Epic 11: 5 points/story → 70 points total
- Epic 12: 8 points/story → 80 points total
