...
- 🚫 Blocking gates that prevent proceeding until standards are met
- ✅ TDD enforcement (tests generated BEFORE code)
- 🎯 99-100/100 quality scores (vs 85-95/100 standard mode)
- 🔧 Comprehensive auto-fix (3 attempts, 60-95% success rate)

### When to Use Interactive Mode

<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <div className="p-4 border border-green-500/50 rounded-lg bg-green-500/5">
    <h5 className="mb-2">✅ Use Interactive Mode When:</h5>
    <ul className="text-sm space-y-1 muted">
      <li>• Creating components for the first time</li>
      <li>• Need guided step-by-step workflow</li>
      <li>• Want zero quality violations guaranteed</li>
      <li>• Learning component generation best practices</li>
      <li>• Complex components with multiple requirements</li>
      <li>• Enforcing TDD (tests before code)</li>
    </ul>
  </div>
  <div className="p-4 border border-blue-500/50 rounded-lg bg-blue-500/5">
    <h5 className="mb-2">💨 Use Standard Mode When:</h5>
    <ul className="text-sm space-y-1 muted">
      <li>• Quick, simple components</li>
      <li>• Experienced with quality standards</li>
      <li>• Will validate manually later</li>
      <li>• Time-sensitive prototyping</li>
      <li>• Familiar with the workflow</li>
    </ul>
  </div>
</div>
...
<div className="my-6 p-4 border rounded-lg bg-muted/30">
  <div className="space-y-3 text-sm">
    ...
    <div className="flex items-start gap-3">
      ...
      <div>
        <strong>Accessibility Checklist ⚠️ BLOCKING</strong>
    ...
    <div className="flex items-start gap-3">
      ...
      <div>
        <strong>i18n Setup ⚠️ BLOCKING</strong>
    ...
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        <p className="muted text-xs mt-1">6-agent sequence: shadcn → react → typescript → tailwind → i18n → ui-factory</p>
      </div>
    </div>
    <div className="flex items-start gap-3">
      <span className="font-mono bg-destructive text-destructive-foreground px-2 py-1 rounded">9</span>
      <div>
        <strong>Quality Gates ⚠️ BLOCKING</strong>
...
<div className="space-y-4 my-6">
  <div className="p-4 border border-destructive/50 rounded-lg bg-destructive/5">
    <h6 className="mb-2">🚫 Gate 1: Accessibility (Step 5)</h6>
    <p className="text-sm mb-2">ALL 6 WCAG 2.1 AA requirements must be confirmed:</p>
    <ul className="text-xs space-y-1 muted ms-4">
      <li>☑ ARIA labels defined</li>
      <li>☑ Keyboard navigation (Enter, Space, Arrows, Escape, Tab)</li>
      <li>☑ Focus management and focus trap</li>
      <li>☑ Color contrast ≥4.5:1 (text) and ≥3:1 (UI)</li>
      <li>☑ Touch targets ≥44x44px</li>
      <li>☑ Screen reader compatible</li>
    </ul>
    <p className="text-xs mt-2 muted">⚠️ Cannot proceed if ANY item is unchecked. This is non-negotiable.</p>
  </div>

  <div className="p-4 border border-destructive/50 rounded-lg bg-destructive/5">
    <h6 className="mb-2">🚫 Gate 2: i18n (Step 6)</h6>
    ...
    <p className="text-xs mt-2 muted">⚠️ Cannot use non-existent keys. Add them to dictionaries.ts first or use existing keys.</p>
  </div>

  <div className="p-4 border border-destructive/50 rounded-lg bg-destructive/5">
    <h6 className="mb-2">🚫 Gate 3: Quality Validation (Step 9)</h6>
    ...
    <p className="text-xs mt-2 muted">⚠️ Cannot commit component with critical or high severity violations.</p>
  </div>
</div>
...
? Enter name (PascalCase):
  → MultiStepForm
  ✓ Valid (unique, PascalCase, 3-50 chars)
...
# Step 7-11: AUTO
🔨 Generating tests... ✓ 97% coverage
🔨 Generating component... ✓ Complete
🔍 Validating... ✓ 99/100 PASS
📝 Committing... ✓ abc123d
...
### `/ui-interactive` - Interactive Wizard ⭐ NEW
...
<div className="space-y-2 my-4">
  ...
  <div className="p-3 border rounded">
    ...
    <p className="muted text-sm mt-1">Checks test coverage ≥ 95% across all categories</p>
  </div>
  <div className="p-3 border rounded">
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
  <div>
    <h6 className="mb-2">❌ Bad (Violations)</h6>
    ```tsx
    bg-white
    bg-gray-50
    text-black
  ...
  <div>
    <h6 className="mb-2">✅ Good (Correct)</h6>
    ```tsx
    bg-background
    bg-muted
    text-foreground
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
  <div>
    <h6 className="mb-2">❌ Bad (Hardcoded)</h6>
    ```tsx
  ...
  <div>
    <h6 className="mb-2">✅ Good (i18n)</h6>
    ```tsx
    // Client component
...
**What it checks:**
- ❌ Hardcoded colors (semantic token violations)
- ❌ Typography utilities on divs (semantic HTML violations)
- ❌ Hardcoded English text (i18n violations)
...
- 🌍 Full RTL/LTR internationalization
