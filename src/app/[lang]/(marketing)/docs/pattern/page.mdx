---
title: "Patterns"
description: "Established patterns that ensure our codebase remains scalable, readable, and collaborative"
---
...
### Files and Folders
- **Components**: kebab-case for component files (`button.tsx`, `user-profile.tsx`)
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="p-6 border rounded-lg">
    <h4 className="mb-2">Arrow Functions</h4>
    ...
    <pre className="muted bg-muted p-2 rounded">
{`const formatPrice = (amount: number) => {
  ...
  <div className="p-6 border rounded-lg">
    <h4 className="mb-2">Function Declarations</h4>
    <p className="muted mb-4">
...
We use generics to keep types reusable across entities, tables, actions, and forms. See the dedicated guide: [/docs/architecture/generics](/docs/architecture/generics).
...
const buttonVariants = cva(
          "inline-flex items-center justify-center rounded-md muted font-medium",
  {
    variants: {
      variant: {
