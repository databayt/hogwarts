...
import { getTemporaryAccessToken } from '@/components/receipts/schematic/get-temporary-access-token'
import SchematicEmbed from '@/components/receipts/schematic/schematic-embed'
