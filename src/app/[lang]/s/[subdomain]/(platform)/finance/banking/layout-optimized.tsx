...
const BankingSidebar = dynamic(
  () => import('@/components/platform/finance/banking/shared/sidebar').then(mod => mod.BankingSidebar),
  {
...
const BankingMobileNav = dynamic(
  () => import('@/components/platform/finance/banking/shared/mobile-nav').then(mod => mod.BankingMobileNav),
  {
