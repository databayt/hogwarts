...
const TransactionsTable = dynamicImport(
  () => import('@/components/platform/finance/banking/transaction-history/table').then(mod => mod.TransactionsTable),
  {
...
//   () => import('@/components/platform/finance/banking/transaction-history/filters').then(mod => mod.TransactionFilters),
//   {
...
async function TransactionData({
  ...
  const { getTransactionsByUserId } = await import('@/components/platform/finance/banking/actions/transaction.actions')
