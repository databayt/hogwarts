...
export async function generateMetadata({ params }: StudentsAnalysisProps): Promise<Metadata> {
...
export default async function StudentsAnalysis({ params }: StudentsAnalysisProps) {
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border bg-card p-8">
          <div className="space-y-4">
            <h3 className="text-foreground">{dict.analysis || 'Student Analysis'}</h3>
            <p className="text-muted-foreground">
              This page is under construction. Student analytics and reporting features will be available here soon.
            </p>
            <p className="text-muted-foreground">
