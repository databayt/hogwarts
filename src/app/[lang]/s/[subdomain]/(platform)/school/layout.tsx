...
export default async function SchoolLayout({ children, params }: Props) {
  ...
  const schoolPages: PageNavItem[] = [
    ...
    { name: isArabic ? 'الإعدادات' : 'Configuration', href: `/${lang}/school/configuration` },
    { name: isArabic ? 'إدخال جماعي' : 'Bulk', href: `/${lang}/school/bulk` },
    { name: isArabic ? 'التقارير' : 'Reports', href: `/${lang}/school/reports` },
    { name: isArabic ? 'التحليل' : 'Analysis', href: `/${lang}/school/analysis` },
  ]
