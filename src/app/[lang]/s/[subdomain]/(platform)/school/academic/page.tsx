...
export const metadata: Metadata = {
  ...
  description: 'Configure academic years, terms, periods, year levels, and grading scale'
}
...
export default async function Page({ params }: Props) {
  ...
  // Get totals
  const [totalYears, totalTerms, totalPeriods, totalLevels, totalGrades] = await Promise.all([
