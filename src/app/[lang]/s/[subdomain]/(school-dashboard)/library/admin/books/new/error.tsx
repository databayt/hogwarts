...
export default function LibraryAdminNewBookError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Library admin new book error:", error)
  }, [error])
    ...
    <div className="layout-container flex min-h-[60vh] items-center justify-center">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            {error.message || "An error occurred while loading the book form."}
          </CardDescription>
        </CardHeader>
        <CardContent>
