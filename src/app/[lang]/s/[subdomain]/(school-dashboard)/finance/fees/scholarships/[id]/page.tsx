      ...
      <div className="grid gap-4 sm:grid-cols-4">
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground text-sm">Coverage Type</p>
            <Badge
              variant="outline"
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground text-sm">Coverage Amount</p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="grid gap-3">
            ...
            <div className="flex justify-between">
              <span className="text-muted-foreground">Max Family Income</span>
              <span className="tabular-nums">
