...
export async function GET(
  ...
  try {
    ...
    // guardian may read this student's attendance. The previous code
    // allowed any authenticated user in the school to read any student's
    // ledger by guessing the studentId.
