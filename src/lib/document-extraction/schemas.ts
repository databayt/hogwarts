...
export const titleExtractionSchema = z.object({
  schoolName: z
    .string()
    .optional()
    .describe("Official name of the school or educational institution"),
  subdomain: z
    .string()
    .optional()
    .describe(
      "Proposed subdomain (lowercase, no spaces, letters and numbers only)"
    ),
...
export const descriptionExtractionSchema = z.object({
  ...
  values: z
    .array(z.string())
    .optional()
    .describe("Core values of the institution"),
  description: z
    .string()
    .optional()
    .describe("General description or overview of the school"),
})
...
export const capacityExtractionSchema = z.object({
  totalStudents: z
    ...
    .positive()
    .optional()
    .describe("Total student enrollment capacity"),
  totalTeachers: z
    .number()
    .int()
    .positive()
    .optional()
    .describe("Total number of teachers or faculty"),
  totalClasses: z
    .number()
    .int()
    .positive()
    .optional()
    .describe("Total number of classes or classrooms"),
  maxClassSize: z
    .number()
    .int()
    .positive()
    .optional()
    .describe("Maximum students per class"),
  facilities: z
    .array(z.string())
    .optional()
    .describe("List of facilities (library, lab, gym, etc.)"),
})
...
export const priceExtractionSchema = z.object({
  ...
  tuitionFee: z
    ...
    .positive()
    .optional()
    .describe("Annual or semester tuition fee"),
  registrationFee: z
    .number()
    .positive()
    .optional()
    ...
    .array(
      z.object({
        ...
        frequency: z
          .string()
          .optional()
          .describe("Payment frequency (monthly, annual, one-time)"),
      })
    )
    .optional()
    .describe("Other fees and charges"),
})
...
export type SchemaForStep<T extends keyof StepSchemaMap> = z.infer<
  StepSchemaMap[T]
>
