 ...
 */
export const convertToHSL = (colorValue: string): string => colorFormatter(colorValue, 'hsl', '4')

/**
 * Convert any color to HEX format
 */
export const convertToHex = (colorValue: string): string => colorFormatter(colorValue, 'hex')

/**
 * Convert any color to OKLCH format
 */
export const convertToOKLCH = (colorValue: string): string => colorFormatter(colorValue, 'oklch')
