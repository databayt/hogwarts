...
13. **Protected Test Accounts** - `dev@balqalam.com` role is DEVELOPER and must never be reset. Bulk `updateMany` with `role:` must exclude protected emails. See `.Codex/rules/accounts.md`.
